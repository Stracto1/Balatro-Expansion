...
Descriptions.Other.EmptySlot = "Lo spazio \232 vuoto!"
...
Descriptions.Other.NotActive = "{{ColorMult}}Non attivo!"
...
Descriptions.Jimbo.Enhancement = {[mod.Enhancement.NONE]  = "",
                                  ...
                                  [mod.Enhancement.GLASS] = "#{{REG_Glass}} {{ColorYellorange}}Carta di Vetro{{CR}}: #{{IND}}{{Damage}} {{ColorMult}}x1.2{{CR}} Molt. di Danno quando attivata ##{{IND}}!!! {{ColorMint}}[[CHANCE]] probabilit\224 su 10{{CR}} di venir distrutta quando attivata",
                                  ...
                                  [mod.Enhancement.LUCKY] = "#{{REG_Lucky}} {{ColorYellorange}}Carta Fortunata{{CR}}: #{{IND}}{{Damage}} {{ColorMint}}[[CHANCE]] probabilit\224 su 5{{CR}} di dare {{ColorMult}}+0.2{{CR}} Danno #{{IND}}{{Coin}} {{ColorMint}}[[CHANCE]] probabilit\224 su 20{{CR}} di dare {{ColorYellorange}}10 Pennies",
...
Descriptions.Jimbo.Seal = {[mod.Seals.NONE] = "",
                           [mod.Seals.RED] = "#{{REG_Red}} {{ColorYellorange}}Sigillo Rosso{{CR}}: #{{IND}}{{REG_Retrigger}} {{ColorYellorange}}Riattiva{{CR}} le abilit\224 della carta",
                           [mod.Seals.BLUE] = "#{{REG_Blue}} {{ColorYellorange}}Sigillo Blu{{CR}}:  #{{IND}}{{REG_Planet}} Crea il corrispettivo {{ColorCyan}}Pianeta{{CR}} se tenuta in mano quando un {{ColorYellorange}}Buio{{CR}} \232 sconfitto",
                           ...
                           [mod.Seals.PURPLE] = "#{{REG_Purple}} {{ColorYellorange}}Sigillo Viola{{CR}}: #{{IND}}{{Card}} Crea un {{ColorPink}}Tarocco{{CR}} casuale quando {{ColorRed}}Scartata{{CR}} #{{IND}}!!! {{ColorMint}}Minore probabilit\224{{CR}} se pi\242 sono scartate {{ColorYellorange}}insieme",
                           }
...
Descriptions.Jimbo.Jokers[mod.Jokers.MISPRINT] = "{{Damage}} {{ColorMult}}+0-1{{CR}} Danno casuale ogni stanza #{{Collectible721}} {{ColorMint}}[[CHANCE]] probabilit\224 su 10{{CR}} di rendere un oggetto {{ColorYellorange}}glitchato"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ROCKET] = "{{Coin}} {{ColorYellorange}}+[[VALUE1]] {{Coin}} Monete{{CR}} quando un Buio viene sconfitto#{{IND}}{{Coin}} La ricompensa aumenta di {{ColorYellorange}}1{{CR}} quando un {{ColorYellorange}}Buio Boss{{CR}} viene sconfitto #{{Collectible583}} D\224 l'effetto di Rocket in Jar"
Descriptions.Jimbo.Jokers[mod.Jokers.ODDTODD] = "{{Tears}} Le carte {{ColorYellorange}}Dispari{{CR}} danno {{ColorChips}}+0.31{{CR}} Lacrime quando attivate#{{Tears}} {{ColorChips}}+0.15{{CR}} Lacrime per oggetto avuto se il numero totale \232 dispari"
Descriptions.Jimbo.Jokers[mod.Jokers.EVENSTEVEN] = "{{Damage}} Le carte {{ColorYellorange}}Pari{{CR}} danno {{ColorMult}}+0.04{{CR}} Danno quando attivata #{{Damage}} {{ColorMult}}+0.02{{CR}} Danno per oggetto tenuto se il numero totale \232 pari"
Descriptions.Jimbo.Jokers[mod.Jokers.HALLUCINATION] = "{{Card}} {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} to creare un {{ColorPink}}Tarocco{{CR}} casuale aprendo un {{ColorYellorange}}Busta di Espansione{{CR}} #{{Collectible431}} D\224 l'effetto di Multidimensional Baby"
...
Descriptions.Jimbo.Jokers[mod.Jokers.VAGABOND] = "Crea un {{Card}}{{ColorPink}}Tarocco{{CR}} casuale completando una stanza con {{ColorYellorange}}massimo 2 {{Coin}} Monete{{CR}} #{{Beggar}} {{ColorMint}}[[CHANCE]] probabilit\224 su 10{{CR}} di creare un {{ColorYellorange}}Beggar{{CR}} casuale completando una stanza"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FORTUNETELLER] = "{{Damage}} {{ColorMult}}+0.04{{CR}} Danno per {{Card}}{{ColorPink}}Tarocco{{CR}} usato questa partita #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}+[[VALUE1]]{{ColorGray}} Danno) #{{Collectible451}} D\224 l'effetto di Tarot Cloth"
Descriptions.Jimbo.Jokers[mod.Jokers.BLUEPRINT] = "{{REG_Retrigger}} Copia il Jolly alla sua destra"
Descriptions.Jimbo.Jokers[mod.Jokers.BRAINSTORM] = "{{REG_Retrigger}} Copia il Jolly pi\242 a sinistra"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MR_BONES] = "Resuscuta a cuori pieni se solo {{ColorYellorange}}1{{CR}} Buio non \232 sconfitto #!!! I Bui non disponibili contano come sconfitti #{{ColorMint}}[[CHANCE]] probabilit\224 su 5{{CR}} di attivare {{Collectible545}} Book of the Dead completando una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.ONIX_AGATE] = "{{Damage}} Le carte di {{REG_Club}} {{ColorChips}}Fiori{{CR}} danno {{ColorMult}}+0.07{{CR}} Danno quando attivate #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}+[[VALUE1]]{{ColorGray}} Danno) #{{Bomb}} Le esplosioni di {{ColorClub}}Fiori{{CR}} sono pi\242 frequenti, pi\242 grandi infliggono pi\242 danno"
Descriptions.Jimbo.Jokers[mod.Jokers.ARROWHEAD] = "{{Tears}} Le carte di {{REG_Spade}} {{ColorSpade}}Picche{{CR}} danno {{ColorChips}}+0.5{{CR}} Lacrime quando attivate #{{Blank}} {{ColorGray}}(Attualmente {{ColorChips}}+[[VALUE1]]{{ColorGray}} Lacrime) #{{Confusion}} Le carte di {{ColorSpade}}Picche{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di rallentare e confondere"
Descriptions.Jimbo.Jokers[mod.Jokers.BLOODSTONE] = "{{Damage}} Le carte di {{REG_Heart}} {{ColorMult}}Cuori{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di dare {{ColorMult}}X1.05{{CR}} Molt. di Danno quando attivate #{{REG_Heart}} Le carte di {{ColorMult}}Cuori{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 5{{CR}} di {{Charm}} ammaliare"
Descriptions.Jimbo.Jokers[mod.Jokers.ROUGH_GEM] = "{{Coin}} Le carte di {{REG_Diamond}} {{ColorYellorange}}Quadri{{CR}} hannoa {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di creare una {{Coin}} {{ColorYellorange}}Moneta Temporanea{{CR}} quando attivate #{{Collectible506}} Le carte di  {{REG_Diamond}} {{ColorYellorange}}Quadri{{CR}} hanno anche l'effetto di {{ColorYellorange}}Backstabber"

Descriptions.Jimbo.Jokers[mod.Jokers.GROS_MICHAEL] = "{{Damage}} {{ColorMult}}+0.75{{CR}} Danno #{{Warning}} {{ColorMint}}[[CHANCE]] probabilit\224 su 6{{CR}} di distruggersi quando un Buio viene sconfitto"
Descriptions.Jimbo.Jokers[mod.Jokers.CAVENDISH] = "{{Damage}} {{ColorMult}}X1.5{{CR}} Molt. di Danno #{{Warning}} {{ColorMint}}[[CHANCE]] probabilit\224 su 1000{{CR}} di distruggersi quando un Buio viene sconfitto"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CLOUD_NINE] = "{{Coin}} {{ColorYellorange}}+1${{CR}} per {{ColorYellorange}}9{{CR}} nel tuo mazzo completo #{{Blank}} {{ColorGray}}(Attualmente  {{ColorYellorange}}[[VALUE1]]{{ColorGray}} Coins){{CR}} #{{Seraphim}} D\224 volo"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CARTOMANCER] = "{{Card}} Crea un {{ColorPink}}Tarocco{{CR}} casuale quando un Buio viene sconfitto #{{Card}} {{ColorMint}}[[CHANCE]] probabilit\224 su 20{{CR}} per ogni pickup di essere un {{ColorPink}}Tarocco"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SLY_JOKER] = "{{Tears}} {{ColorChips}}+5{{CR}} Lacrime se una {{ColorYellorange}}Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.WILY_JOKER] = "{{Tears}} {{ColorChips}}+10{{CR}} Lacrime se un {{ColorYellorange}}Tris{{CR}} \232 tenuto in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.CLEVER_JOKER] = "{{Tears}} {{ColorChips}}+7{{CR}} Lacrime se una {{ColorYellorange}}Doppia Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.DEVIOUS_JOKER] = "{{Tears}} {{ColorChips}}+15{{CR}} Lacrime se una {{ColorYellorange}}Scala{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.CRAFTY_JOKER] = "{{Tears}} {{ColorChips}}+12{{CR}} Lacrime se un {{ColorYellorange}}Colore{{CR}} \232 tenuto in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.JOLLY_JOKER] = "{{Damage}} {{ColorMult}}+1{{CR}} Danno se una {{ColorYellorange}}Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.ZANY_JOKER] = "{{Damage}} {{ColorMult}}+2{{CR}} Danno se un {{ColorYellorange}}Tris{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.MAD_JOKER] = "{{Damage}} {{ColorMult}}+1.75{{CR}} Danno se una {{ColorYellorange}}Doppia Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.CRAZY_JOKER] = "{{Damage}} {{ColorMult}}+3{{CR}} Danno se una {{ColorYellorange}}Scala{{CR}} \232 tenuta in mano entrando in una stanza"

Descriptions.Jimbo.Jokers[mod.Jokers.MIME] = "{{REG_Retrigger}} {{ColorYellorange}}Riattiva{{CR}} le abilit\224 {{ColorYellorange}}tenute in mano{{CR}} #{{ColorMint}}[[CHANCE]] probabilit\224 su 5{{CR}} di copiare l'effetto di un Oggetto Attivo usato"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BANNER] = "{{Tears}} {{ColorChips}}+1.5{{CR}} Lacrime per {{Heart}} {{ColorYellorange}}Cuore pieno #{{Blank}} {{ColorGray}}(Attualmente {{ColorChips}}+[[VALUE1]]{{ColorGray}} Lacrime) #Uno stendardo appare entrando in una stanza #{{IND}}{{Tears}} Stare vicino allo stendardo d\224 {{ColorChips}}+3{{CR}} Lacrime"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MARBLE_JOKER] = "{{REG_Stone}} Aggiunge una {{ColorYellorange}}Carta di Pietra{{CR}} al mazzo ogni {{ColorYellorange}}Buio{{CR}} sconfitto #{{ColorMint}}[[CHANCE]] probabilit\224 su 100{{CR}} aggiuntiva di generare delle {{ColorYellorange}}Tinted Rock"
Descriptions.Jimbo.Jokers[mod.Jokers._8_BALL] = "{{Card}} Gli {{ColorYellorange}}8{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 8{{CR}} di creare un {{Card}} {{ColorPink}}Tarot{{CR}} tarocco casuale quando attivati #{{Shotspeed}} +0.16 Shot Speed"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RAISED_FIST] = "{{Damage}} {{ColorMult}}+0.05{{CR}} Danno {{ColorYellorange}}X il Valore{{CR}} pi\242 basso delle carte {{ColorYellorange}}tenute in mano{{CR}} #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FIBONACCI] = "{{Damage}} Gli {{ColorYellorange}}Assi{{CR}}, {{ColorYellorange}}2{{CR}}, {{ColorYellorange}}3{{CR}}, {{ColorYellorange}}5{{CR}} e {{ColorYellorange}}8{{CR}} danno {{ColorMult}}+0.08{{CR}} Danno quando attivati #{{Damage}} {{ColorMult}}+0.05{{CR}} Danno per {{Collectible}} oggetto avuto se il numero totale \232 nella sequanza di {{ColorYellorange}}Fibonacci #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SCARY_FACE] = "{{Tears}} Le {{REG_Face}} {{ColorYellorange}}Figure{{CR}} danno {{ColorChips}}+0.3{{CR}} Lacrime quando attivate #{{Tears}} Uccidere un {{ColorYellorange}}Champion{{CR}} d\224 {{ColorChips}}+1{{CR}} Lacrime"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PAREIDOLIA] = "{{REG_Face}} Ogni carta conta come {{ColorYellorange}}Figure{{CR}} #{{ColorMint}}[[CHANCE]] probabilit\224 su 5{{CR}} aggiuntiva per ongi nemico non boss di essere un {{ColorYellorange}}Champion"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BUSINESS_CARD] = "{{Coin}} Le {{ColorYellorange}}Figure{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di creare {{ColorYellorange}}2 Monete Temporanee{{CR}} quando attivate #{{Collectible602}} Ottieni l'effetto di Member Card"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SPACE_JOKER] = "{{REG_Planet}} {{ColorMint}}[[CHANCE]] probabilit\224 su 20{{CR}} di potenziare il livello del {{ColorYellorange}}Valore{{CR}} attivato # {{ColorMint}}[[CHANCE]] probabilit\224 su 20{{CR}} per oggetto {{ColorYellorange}}Stellare{{CR}} avuto"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SEANCE] = "{{REG_Spectral}} Crea una {{ColorYellorange}}Busta Spettrale{{CR}} entrando in una stanza ostile {{ColorYellorange}}inesplorata{{CR}} avendo una {{ColorYellorange}}Scala Colore{{CR}} in mano #{{Collectible727}} {{ColorMint}}[[CHANCE]] possibilit\224 su 6{{CR}} di creare una {{ColorYellorange}}Hungry Soul{{CR}} uccidendo un nemico"
Descriptions.Jimbo.Jokers[mod.Jokers.VAMPIRE] = "{{Damage}} Quando una carta {{ColorYellorange}}Potenziata{{CR}} \232 giocata, ottiene {{ColorMult}}X0.02{{CR}} Molt. di Danno e rimuove il {{ColorYellorange}}Potenziamento {{CR}} #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}X[[VALUE1]]{{ColorGray}} Molt. di Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PHOTOGRAPH] = "{{Damage}} La prima {{REG_Face}} {{ColorYellorange}}Figura attivata{{CR}} della stanza d\224 {{ColorMult}}X1.25{{CR}} Molt. di Danno quando attivata #{{Damage}} {{ColorMult}}X1.5{{CR}} Molt. di Danno se il primo neico ucciso della stanza \232 un {{ColorYellorange}}Champion #{{Collectible327}} Pu\242 aprire la {{ColorYellorange}}Srange Door"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RESERVED_PARK] = "{{Coin}} Le {{REG_Face}} {{ColorYellorange}}Figure{{CR}} tanute in manoo hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di creare una moneta completando una stanza #{{Coin}} Uccidendo un nemico, gli altri {{ColorYellorange}}Champion{{CR}} creano una {{ColorYellorange}}Moneta Temporanea"
...
Descriptions.Jimbo.Jokers[mod.Jokers.LUCKY_CAT] = "{{Damage}} Ottiene {{ColorMult}}X0.02{{CR}} Molt. di Danno quando una {{ColorYellorange}}Carta Fortunata{{CR}} si attiva con {{ColorMint}}Successo{{CR}} o quando una {{Slotmachine}} Slot d\224 un premio #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}X[[VALUE1]]{{ColorGray}} Molt. di Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SPARE_TROUSERS] = "{{Damage}} Ottiene {{ColorMult}}+0.25{{CR}} Danno se una {{ColorYellorange}}Doppia Coppia{{CR}} \232 tenuta entrando in una stanza ostile #{{Damage}} {{ColorMult}}+0.1{{CR}} Danno per {{ColorYellorange}}costume{{CR}} visibile #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SMILEY_FACE] = "{{Damage}} Le {{REG_Face}} {{ColorYellorange}}Figure{{CR}} danno {{ColorMult}}+0.05{{CR}} Danno quando attivate #{{Damage}} Uccidere un {{ColorYellorange}}Champion{{CR}} d\224 {{ColorMult}}+0.15{{CR}} Danno #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.GOLDEN_TICKET] = "{{REG_Gold}} Le {{ColorYellorange}}Carte Dorate{{CR}} danno {{ColorYellorange}}+1 {{Coin}} Moneta{{CR}} quando attivate #{{Collectible202}} Ogni pickup ha {{ColorMint}}[[CHANCE]] probabilit\224 su 25{{CR}} di diventare la sua variante {{ColorYellorange}}dorata"
...
Descriptions.Jimbo.Jokers[mod.Jokers.HANG_CHAD] = "{{REG_Retrigger}} {{ColorYellorange}}Riattiva{{CR}} 3 volte la prima {{ColorYellorange}}carta{{CR}} giocata in una stanza #{{Card}} La {{ColorYellorange}}prima{{CR}} carta usata di un piano crea una copia di s\232 stessa qunado usata"
Descriptions.Jimbo.Jokers[mod.Jokers.GLASS_JOKER] = "{{Damage}} Ottiene {{ColorMult}}X0.2{{CR}} Molt. di Danno per {{ColorYellorange}}Carta di Vetro{{CR}} distrutta  #{{IND}}!!! {{ColorMint}}Raddioppia{{CR}} la possibilit\224 di rottura #{{Blank}} {{ColorGray}}(Attualmente {{ColorMult}}X[[VALUE1]]{{ColorYellorange}} Molt. di Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FLOWER_POT] = "{{Damage}} {{ColorMult}}X2{{CR}} Molt. di Danno se ogni {{ColorYellorange}}Seme{{CR}} \232 tenuto in mano entrando in una stanza ostile #{{Charm}} Crea 3 fiori ammalianti nelle stanze ostili"
...
Descriptions.Jimbo.Jokers[mod.Jokers.OOPS_6] = "{{Luck}} Ogni {{ColorMint}}Probabilit\224{{CR}} \232 raddoppiata #{{Collectible46}} Ottieni l'effetto di Lucky Foot"
Descriptions.Jimbo.Jokers[mod.Jokers.IDOL] = "{{Damage}} [[VALUE1]]{{CR}} d\224 {{ColorMult}}X1.1{{CR}} Molt. di Danno quando attivato #{{ColorGray}} (Carta cambia ongi stanza) #{{Damage}} {{ColorMult}}X2{{CR}} Molt. di Danno per {{ColorYellorange}} {{Collectible[[VALUE2]]}} [[VALUE3]]{{CR}} avuto"
...
Descriptions.Jimbo.Jokers[mod.Jokers.DUO] = "{{Damage}} {{ColorMult}}X1.25{{CR}} Molt. di Danno se una {{ColorYellorange}}Coppia{{CR}} \232 tenuta entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.TRIO] = "{{Damage}} {{ColorMult}}X1.5{{CR}} Molt. di Danno se un {{ColorYellorange}}Tris{{CR}} \232 tenuto entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.FAMILY] = "{{Damage}} {{ColorMult}}X2{{CR}} Molt. di Danno se un {{ColorYellorange}}Poker{{CR}} \232 tenuto entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.ORDER] = "{{Damage}} {{ColorMult}}X2.5{{CR}} Molt. di Danno se una {{ColorYellorange}}Scala{{CR}} \232 tenuta entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.TRIBE] = "{{Damage}} {{ColorMult}}X1.55{{CR}} Molt. di Danno se un {{ColorYellorange}}Colore{{CR}} \232 tenuto entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ASTRONOMER] = "{{Shop}} Le {{ColorCyan}}Carte Planet{{CR}}, {{ColorCyan}}Buste Celestiali{{CR}} e gli oggetti {{ColorYellorange}}Stellari{{CR}} sono gratuiti #{{Planetarium}} {{ColorYellorange}}+20%{{CR}} possibilit\224 del planetario {{ColorGray}}(Dimezzata per ogni planetario visitato) #{{Planetarium}} I Planetari possono apparire in ogni piano normale"
...
Descriptions.JokerSynergies[mod.Jokers._8_BALL][CollectibleType.COLLECTIBLE_MAGIC_8_BALL] = "{{ColorMint}}Probabilit\224{{CR}} raddoppiata!"

Descriptions.JokerSynergies[mod.Jokers.MISPRINT] = {}
Descriptions.JokerSynergies[mod.Jokers.MISPRINT][CollectibleType.COLLECTIBLE_TMTRAINER] = "Il danno dato \232 compreso tra {{ColorMult}}-0.5{{CR}} e {{ColorMult}}+2.5"
...
Descriptions.JokerSynergies[mod.Jokers.GOLDEN_JOKER][CollectibleType.COLLECTIBLE_SMELTER] = "{{Coin}} D\224 anche 2 {{ColorYellorange}}Monete dorate{{CR}} quando vednuto in questo modo"
...
Descriptions.JokerSynergies[mod.Jokers.CREDIT_CARD][CollectibleType.COLLECTIBLE_MONEY_EQUALS_POWER] = "{{Coin}} Essere in debito conta come avere la met\224 delle monete massime #{{Colorgray}} (Non \232 un bug, ma una peculiarit\224 ;) )" --ye ok it's actually a bug
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_C_SECTION] = "#{{REG_Jimbo}} Le carte sparano un feto quando atterrano #{{IND}}{{REG_Heart}} Le carte di {{ColorMult}}Cuori{{CR}} sparano un feto in pi\242 #{{REG_Heart}} Le carte in mano diventano di {{ColorMult}}Cuori{{CR}} quando preso"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_SPIRIT_SWORD] = "#{{REG_Jimbo}} La spada \232 applicata assieme allo sparare carte"
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_HALLOWED_GROUND] = "#{{REG_Jimbo}} le carte giocate vengono {{REG_Retrigger}} {{ColorYellorange}}Riattivate{{CR}} mentre si \232 all'interno dell'aura"
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_STAR_OF_BETHLEHEM] = "#{{REG_Jimbo}} le carte giocate vengono {{REG_Retrigger}} {{ColorYellorange}}Riattivate{{CR}} mentre si \232 all'interno dell'aura"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_CUPIDS_ARROW] = "#{{REG_Jimbo}} Le carte di {{REG_Spade}} {{ColorSpade}}Picche{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di {{Charm}} ammaliare i nemici"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_CRYSTAL_BALL] = "#{{REG_Jimbo}} D\224 l'effetto del {{Collectible"..mod.Vouchers.Crystal.."}} Voucher Palla di Cristallo mentre tenuto"
...
Descriptions.T_Jimbo.Enhancement[mod.Enhancement.GLASS] = "# {{ColorMult}}X2{{CR}} Molt # {{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di rompersi quando giocata"
Descriptions.T_Jimbo.Enhancement[mod.Enhancement.LUCKY] = "# {{ColorMint}}[[CHANCE]] possibilit\224 su 5{{CR}} di {{ColorMult}}+20{{CR}} Molt #{{ColorMint}}[[CHANCE]] probabilit\224 su 20{{CR}} di {{ColorYellorange}}+20$"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.HALLUCINATION] = "{{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} to create a{{ColorPink}}Tarot{{CR}} card when opening a {{ColorYellorange}}Busta di Espansione"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.BRAINSTORM] = "Copia l'effetto del {{ColorYellorange}}Jolly{{CR}} pi\242 a sinistra #{{ColorGray}}([[VALUE1]]{{ColorGray}})"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.MR_BONES] = "{{ColorMult}}Previene la morte{{CR}} e si {{ColorYellorange}}autodistrugge{{CR}} se il nemico con pi\242 HP non supera il {{ColorYellorange}}75% del punteggio base del buio"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.BLOODSTONE] = "Le carte di {{ColorMult}}Cuori{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di {{ColorMult}}X1.5{{CR}} Molt quando attivate"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.GROS_MICHAEL] = "{{ColorMult}}+15{{CR}}Molt #{{ColorMint}}[[CHANCE]] probabilit\224 su 6{{CR}} of getting destoroyed every round"
Descriptions.T_Jimbo.Jokers[mod.Jokers.CAVENDISH] = " {{ColorMult}}X3{{CR}}Molt # {{ColorMint}}[[CHANCE]] probabilit\224 su 1000{{CR}} of getting destroyed every round"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.SUPERNOVA] = "Aggiunge il numero di volte che la {{ColorYellorange}}Mano di Poker{{CR}} \232 stata giocata a {{ColorMult}}Molt"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.MIME] = "{{ColorYellorange}}Riattiva{{CR}} le abilit\224 {{ColorYellorange}}tenute in mano"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers._8_BALL] = "Gli {{ColorYellorange}}8{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di creare un {{ColorPink}}Tarocco{{CR}} qunado attivati"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.FIBONACCI] = "Ogni {{ColorYellorange}}Asso{{CR}}, {{ColorYellorange}}2{{CR}}, {{ColorYellorange}}3{{CR}}, {{ColorYellorange}}5{{CR}} e {{ColorYellorange}}8{{CR}} d\224 {{ColorMult}}+8{{CR}} Molt quando attivato"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.PAREIDOLIA] = "Ogni carta \232 considerata come una {{ColorYellorange}}Fiugra"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.BUSINESS_CARD] = "Le {{ColorYellorange}}Figure{{CR}} hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di dare {{ColorYellorange}}+2${{CR}} quando attivate"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.SPACE_JOKER] = "{{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di potenziare la {{ColorYellorange}}Mano di POker{{CR}} giocata"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.SIXTH_SENSE] = "Se la {{ColorYellorange}}prima{{CR}}mano giocata \232 un singolo {{ColorYellorange}}6{{CR}}, distruggilo e crea una carta {{ColorBlue}}Spettrale"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.TO_DO_LIST] = "Guadagna {{ColorYellorange}}4${{CR}} se la mano giocata \232 {{ColorYellorange}}[[VALUE1]]{{CR}}#(mano cambia ogni round)"

Descriptions.T_Jimbo.Jokers[mod.Jokers.CARD_SHARP] = "{{ColorChips}}X3{{CR}} Molt se la {{ColorYellorange}}Mano di Poker{{CR}} era gi\224 stata giocata questo round"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.OBELISK] = "Ottiene {{ColorMult}}X0.2{{CR}} Molt per mano {{ColorYellorange}}consecutiva{{CR}} giocata senza giocare la tua {{ColorYellorange}}mano di poker{{CR}} pi\242 giocata#{{ColorGray}}(Attualmente {{ColorMult}}X[[VALUE1]]{{ColorGray}}Molt)"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.PHOTOGRAPH] = "La prima {{ColorYellorange}}Figura{{CR}} ad assegnare punti d\224 {{ColorMult}}X2{{CR}} Molt quando attivata"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.RESERVED_PARK] = "Le {{ColorYellorange}}Figure{{CR}} tenute in mano hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di dare {{ColorYellorange}}1$"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.SHOWMAN] = "Le carte {{ColorYellorange}}Jolly{{CR}},{{ColorPink}}Tarocche{{CR}},{{ColorCyan}}Pianeta{{CR}} e {{ColorBlue}}Spettrali{{CR}} possono apparire pi\242 volte"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.OOPS_6] = "Ogni {{ColorMint}}probabilit\224{{CR}} \232 rsddoppiata"
Descriptions.T_Jimbo.Jokers[mod.Jokers.IDOL] = "[[VALUE1]]{{CR}} d\224 {{ColorMult}}X2{{CR}} Molt quando attivata #(Carta cambia ogni round)"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.MATADOR] = "Guadagna {{ColorYellorange}}8${{CR}} quando la mano giocata attiva l'abilit\224 del {{ColorYellorange}}Buio Boss"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.CHICOT] = "Disabilita le abilit\224 dei {{ColorYellorange}}Bui Boss"
Descriptions.T_Jimbo.Jokers[mod.Jokers.PERKEO] = "Uscendo dal {{ColorYellorange}}Negozio{{CR}}, crea una copia {{ColorSpade}}Negativa{{CR}} di un cond\236sumabile avuto casuale"
...
Descriptions.Jimbo.Consumables[Card.CARD_FOOL] = "Crea una copia dell'ultima carta usata #{{IND}}!!! Eccetto s\232 stessa #[[VALUE1]] Attualmente: [[VALUE2]]"
...
Descriptions.Jimbo.Consumables[Card.CARD_EMPEROR] = "{{Card}} Crea {{ColorYellorange}}2{{CR}} {{ColorPink}}Tarocchi{{CR}} casuali #{{IND}}!!! Eccetto s\232 stesso"
...
Descriptions.Jimbo.Consumables[Card.CARD_WHEEL_OF_FORTUNE] = "{{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di dare un'{{ColorYellorange}}Edizione{{CR}} ad un Jolly avuto #{{IND}}!!! Non pu\242 rimpiazzare edizioni gi\224 esistenti"
...
Descriptions.Jimbo.Consumables[Card.CARD_TEMPERANCE] = "{{Coin}} D\224 il {{ColorYellorange}}valore di vendita{{CR}} totale dei Jolly avuti in {{Coin}} Monete"
...
Descriptions.Jimbo.Consumables[Card.CARD_JUDGEMENT] = "{{REG_Joker}} D\224 un {{ColorYellorange}}Jolly{{CR}} casuale #{{IND}}!!! Serve spazio nell'invetario"
...
Descriptions.T_Jimbo.Consumables[Card.CARD_WHEEL_OF_FORTUNE] = "{{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di dara un'{{ColorYellorange}}Edizione{{CR}} ad un Jolly avuto #{{ColorGray}}(Non cambia edizioni esistenti)"
...
Descriptions.Jimbo.Consumables[mod.Spectrals.ECTOPLASM] = "{{REG_Jimbo}} Rende un Jolly casuale {{ColorGray}}{{ColorFade}}Negativo #{{IND}}!!! Non rimpiazza edizioni gi\224 presenti #{{REG_HSize}} {{ColorRed}}-1{{CR}} Carte in mano #{{IND}}!!! Nessun effetto se le carte in mano nono possono essere diminuite"
...
Descriptions.T_Jimbo.Consumables[mod.Spectrals.AURA] = "D\224 un'{{ColorYellorange}}Edizione{{CR}} casuale ad una carta scelta"
...
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.Hone] = "Le {{ColorRainbow}}Edizioni{{CR}} speciali appaiono {{ColorYellorange}}2X{{CR}} pi\242 spesso"
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.GlowUp] = "Le {{ColorRainbow}}Edizioni{{CR}} speciali appaiono {{ColorYellorange}}4X{{CR}} pi\242 spesso"
...
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.Telescope] = "Le {{ColorYellorange}}Buste Celestiali{{CR}} hanno sempre il {{colorCyan}}Pianeta{{CR}} per la tua mano pi\242 giocata"
...
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.TarotMerch] = "I {{ColorPink}}Tarocchi{{CR}} appaiono {{ColorYellorange}}2X{{CR}} pi\242 spesso"
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.TarotTycoon] = "I {{ColorPink}}Tarocchi{{CR}} appaiono {{ColorYellorange}}4X{{CR}} pi\242 spesso"
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.PlanetMerch] = "I {{ColorCyan}}Pianeti{{CR}} appaiono {{ColorYellorange}}2X{{CR}} pi\242 spesso"
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.PlanetTycoon] = "I {{ColorCyan}}Pianeti{{CR}} appaiono {{ColorYellorange}}4X{{CR}} pi\242 spesso"
...
if EID then
    ...
    EID:addCollectible(mod.Vouchers.Overstock, "{{REG_Jimbo}} Ogni negozio futuro avr\224 1 {{REG_Joker}} Jolly aggiuntivo in vendita", "Pi\242 merce", FileLanguage)
    EID:addCollectible(mod.Vouchers.OverstockPlus, "{{REG_Jimbo}} Ogni negozio futuro avr\224 1 {{REG_Joker}} Jolly aggiuntivo in vendita", "Troppa merce", FileLanguage)
    ...
    EID:addCollectible(mod.Vouchers.Hone, "{{REG_Jimbo}} Le {{ColorRainbow}}Edizioni{{CR}} speciali appaiono {{ColorYellorange}}2x{{CR}} pi\242 frequentemente", "Lucidatura", FileLanguage)
    EID:addCollectible(mod.Vouchers.GlowUp, "{{REG_Jimbo}} Le {{ColorRainbow}}Edizioni{{CR}} speciali appaiono {{ColorYellorange}}4x{{CR}} pi\242 frequentemente", "Perfezionamento", FileLanguage)

    EID:addCollectible(mod.Vouchers.RerollSurplus, "{{REG_Jimbo}} Attivare una {{RestockMachine}} Restock Machine rid\224 indietro {{ColorYellorange}}1{{CR}} {{Coin}} Moneta", "Cambi in Surplus", FileLanguage)
    EID:addCollectible(mod.Vouchers.RerollGlut, "{{REG_Jimbo}} Attivare una {{RestockMachine}} Restock Machine rid\224 indietro {{ColorYellorange}}2{{CR}} {{Coin}} Monete", "Eccesso di Cambi", FileLanguage)
    ...
    EID:addCollectible(mod.Vouchers.Telescope, "{{REG_Jimbo}} Saltare una {{ColorCyan}}Busta Celestiale{{CR}} crea {{ColorYellorange}}2{{CR}} {{REG_Planet}} {{ColorCyan}}Carte Pianeta{{CR}} casuali aggiuntive", "Telescopio", FileLanguage)
    ...
    EID:addCollectible(mod.Vouchers.MagicTrick, "Le buste di espansione hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 4{{CR}} di permettere una scelta aggiuntiva dopo la precedente #{{IND}} Pu\242 attivarsi pi\242 volte", "Trucco di Magia", FileLanguage)
    EID:addCollectible(mod.Vouchers.Illusion, "Le buste di espansione hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 2{{CR}} di contenere {{ColorYellorange}}2{{CR}} opzioni in pi\242 #Le buste di espansione hanno {{ColorMint}}[[CHANCE]] probabilit\224 su 5{{CR}} di permettere {{ColorYellorange}}1{{CR}} scelta aggiuntiva", "Illusione", FileLanguage)
...
EID:addCollectible(mod.Collectibles.EMPTY_BANANA, "Lascia una buccia di banana a terra #I nemici possono scivolare sule bucce, prendendo danno e diventando {{Confusion}} confusi #{{IND}} Il danno inflitto scala con la velocit\224 a cui si muoveva il nemico", "Buccia di Banana",FileLanguage)		
EID:addCollectible(mod.Collectibles.CLOWN, "La met\224 dei nemici diventa {{Charm}} Ammaliata o {{Fear}} Impaurita stando vicino ad Isaac", "Costume da Clown",FileLanguage)		
...
EID:addCollectible(mod.Collectibles.POCKET_ACES, "{{Luck}} 8% di probabilit\224 di sparare un asso #Gli assi infliggono danno uguale al prodotto del {{Damage}} Danno e delle {{Tears}} Lacrime di Isaac", "Assi di Tasca",FileLanguage)		
EID:addCollectible(mod.Collectibles.TRAGICOMEDY, "40% di probabilit\224 una maschera {{REG_Comedy}} comica o {{REG_Tragedy}} tragica completando una stanza #{{IND}}!!! Possono essere indossate entrambe #{{REG_Comedy}} La maschera comica d\224: #{{IND}}{{Tears}} +1 Firedelay #{{IND}}{{Speed}} +0.2 Velocit\224  #{{IND}}{{Luck}} +2 Luck #{{REG_Tragedy}} La maschera tragica d\224: #{{IND}}{{Tears}} +0.5 Firedelay,  #{{IND}}{{Damage}} +1 Danno Fisso  #{{IND}}{{Range}} +2.5 Range", "Tragicommedia",FileLanguage)		
...
EID:addCollectible(mod.Collectibles.HEIRLOOM, "{{Coin}} Le monete possono avere il loro valore aumentato #{{Coin}} Tutti i pickup hanno una possibilit\224 maggiore di essere dorati", "Cimelio",FileLanguage)		
EID:addTrinket(mod.Trinkets.PENNY_SEEDS, "{{Coin}} Crea una moneta per ogni 5 monete avute entrando in un nuovo piano #{{IND}} Bassa probabilit\224 che le monete create siano un trinket moneta o {{Collectible74}} The quarter", "Semmy Spiccioli",FileLanguage)		
...
Descriptions.ItemItemSynergies[mod.Collectibles.FUNNY_TEETH] = {[CollectibleType.COLLECTIBLE_APPLE] = "# Lascia una scia di sangue",
                                                                ...
                                                                [CollectibleType.COLLECTIBLE_PLAYDOUGH_COOKIE] = "# Pu\242 applicare effetti di stao casuali",
                                                                [CollectibleType.COLLECTIBLE_ROTTEN_TOMATO] = "# Pu\242 applicare {{Bait}} Adescamento ai nemici",
                                                                [CollectibleType.COLLECTIBLE_MIDAS_TOUCH] = "# Pu\242 rendere i nemici {{Coin}} dorati",
                                                                [CollectibleType.COLLECTIBLE_DEAD_TOOTH] = "# Pu\242 {{Poison}} avvelenare i nemici",
                                                                [CollectibleType.COLLECTIBLE_CHARM_VAMPIRE] = "# Pu\242 curare il possessore di {{HalfHeart}} mezzo cuore rosso uccidendo i nemici",
                                                                [CollectibleType.COLLECTIBLE_SERPENTS_KISS] = "# Pu\242 {{Poison}} avvelenare i nemici # Pu\242 creare un {{BlackHeart}} cuore nero ad ogni nemico ucciso",
                                                                [CollectibleType.COLLECTIBLE_DOG_TOOTH] = "# Danno e velocit\224 aumentati",
                                                                [CollectibleType.COLLECTIBLE_TOUGH_LOVE] = "# Infligge il 35% di danno in pi\242",
...
Descriptions.ItemItemSynergies[mod.Collectibles.TRAGICOMEDY] = {[CollectibleType.COLLECTIBLE_POLAROID] = "# La {{REG_Comedy}} maschera comica \232 sempre attiva",
                                                                [CollectibleType.COLLECTIBLE_SOCKS] = "# La {{REG_Comedy}} maschera comica \232 sempre attiva",
                                                                [CollectibleType.COLLECTIBLE_NEGATIVE] = "# La {{REG_Tragedy}} maschera tragica \232 sempre attiva",
...
Descriptions.ItemItemSynergies[mod.Collectibles.THE_HAND] = {[CollectibleType.COLLECTIBLE_BOOK_OF_VIRTUES] = "# Lancia una fiammella per carta tenuta quando usato",
                                                             [CollectibleType.COLLECTIBLE_MIDAS_TOUCH] = "# Infligge +0.25 danno per ogni {{Coin}} moneta tenuta # Possiblit\224 di trasformere i nemici colpiti in statue dorate",
                                                             [CollectibleType.COLLECTIBLE_KNOCKOUT_DROPS] = "# Raddoppia in danno inflitto ed aumenta la respinta causata",
                                                             [CollectibleType.COLLECTIBLE_SERPENTS_KISS] = "# Pu\242 {{Poison}} avvelenare i nemici colpiti",
                                                             [CollectibleType.COLLECTIBLE_VIRUS] = "# Pu\242 {{Poison}} avvelenare i nemici colpiti",
                                                             [CollectibleType.COLLECTIBLE_TELEKINESIS] = "# Riflette i proiettili colpiti",
                                                             [mod.Collectibles.THE_HAND] = "# Pu\242 tenere 5 carte aggiuntive",
                                                            }
...
Descriptions.ItemItemSynergies[mod.Collectibles.UMBRELLA] = {[CollectibleType.COLLECTIBLE_BOOK_OF_VIRTUES] = "# Fiammella distante con alta probabilit\224 di {{Confsion}} confondere per ogni incudine caduto",

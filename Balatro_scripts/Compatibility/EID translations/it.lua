...
Descriptions.Jimbo.Enhancement = {[mod.Enhancement.NONE]  = "",
                                  ...
                                  [mod.Enhancement.GLASS] = "#{{REG_Glass}} {{REG_Yellow}}Carta di Vetro{{CR}}: #{{IND}}{{Damage}} {{REG_CMult}}x1.2{{CR}} Molt. di Danno quando attivata ##{{IND}}!!! {{REG_Mint}}[[CHANCE]] probabilit\224 su 10{{CR}} di venir distrutta quando attivata",
                                  ...
                                  [mod.Enhancement.LUCKY] = "#{{REG_Lucky}} {{REG_Yellow}}Carta Fortunata{{CR}}: #{{IND}}{{Damage}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 5{{CR}} di dare {{REG_CMult}}+0.2{{CR}} Danno #{{IND}}{{Coin}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 20{{CR}} di dare {{REG_Yellow}}10 Pennies",
                                  ...
                                  [mod.Enhancement.STONE] = "#{{REG_Stone}} {{REG_Yellow}}Carta di Pietra{{CR}}: #{{IND}}{{Tears}} {{REG_CChips}}+1.25{{CR}} Lacrime quando attivata ##{{IND}}!!! Non ha valore o seme"
                                  }

Descriptions.Jimbo.Seal = {[mod.Seals.NONE] = "",
                           [mod.Seals.RED] = "#{{REG_Red}} {{REG_Yellow}}Sigillo Rosso{{CR}}: #{{IND}}{{REG_Retrigger}} {{REG_Yellow}}Riattiva{{CR}} le abilit\224 della carta",
                           [mod.Seals.BLUE] = "#{{REG_Blue}} {{REG_Yellow}}Sigillo Blu{{CR}}:  #{{IND}}{{REG_Planet}} Crea il corrispettivo {{ColorCyan}}Pianeta{{CR}} se tenuta in mano quando un {{REG_Yellow}}Buio{{CR}} \232 sconfitto",
                           ...
                           [mod.Seals.PURPLE] = "#{{REG_Purple}} {{REG_Yellow}}Sigillo Viola{{CR}}: #{{IND}}{{Card}} Crea un {{ColorPink}}Tarocco{{CR}} casuale quando {{ColorRed}}Scartata{{CR}} #{{IND}}!!! {{REG_Mint}}Minore probabilit\224{{CR}} se pi\242 sono scartate {{REG_Yellow}}insieme",
                           }
...
Descriptions.Jimbo.Jokers[mod.Jokers.MISPRINT] = "{{Damage}} {{REG_CMult}}+0-1{{CR}} Danno casuale ogni stanza #{{Collectible721}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 10{{CR}} di rendere un oggetto {{REG_Yellow}}glitchato"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ROCKET] = "{{Coin}} {{REG_Yellow}}+[[VALUE1]] {{Coin}} Monete{{CR}} quando un Buio viene sconfitto#{{IND}}{{Coin}} La ricompensa aumenta di {{REG_Yellow}}2{{CR}} quando un {{REG_Yellow}}Buio Boss{{CR}} viene sconfitto #{{Collectible583}} D\224 l'effetto di Rocket in Jar"
Descriptions.Jimbo.Jokers[mod.Jokers.ODDTODD] = "{{Tears}} Le carte {{REG_Yellow}}Dispari{{CR}} danno {{REG_CChips}}+0.31{{CR}} Lacrime quando attivate#{{Tears}} {{REG_CChips}}+0.15{{CR}} Lacrime per oggetto avuto se il numero totale \232 dispari"
Descriptions.Jimbo.Jokers[mod.Jokers.EVENSTEVEN] = "{{Damage}} Le carte {{REG_Yellow}}Pari{{CR}} danno {{REG_CMult}}+0.04{{CR}} Danno quando attivata #{{Damage}} {{REG_CMult}}+0.02{{CR}} Danno per oggetto tenuto se il numero totale \232 pari"
Descriptions.Jimbo.Jokers[mod.Jokers.HALLUCINATION] = "{{Card}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} to creare un {{ColorPink}}Tarocco{{CR}} casuale aprendo un {{REG_Yellow}}Busta di Espansione{{CR}} #{{Collectible431}} D\224 l'effetto di Multidimensional Baby"
Descriptions.Jimbo.Jokers[mod.Jokers.GREEN_JOKER] = "{{Damage}}{{REG_CMult}}+0.04{{CR}} Danno per stanza completata #{{Damage}}{{REG_CMult}}-0.16{{CR}}Danno ogni mano scartata #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.VAGABOND] = "Crea un {{Card}}{{ColorPink}}Tarocco{{CR}} casuale completando una stanza con {{REG_Yellow}}massimo 2 {{Coin}} Monete{{CR}} #{{Beggar}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 10{{CR}} di creare un {{REG_Yellow}}Beggar{{CR}} casuale completando una stanza"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FORTUNETELLER] = "{{Damage}} {{REG_CMult}}+0.04{{CR}} Danno per {{Card}}{{ColorPink}}Tarocco{{CR}} usato questa partita #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno) #{{Collectible451}} D\224 l'effetto di Tarot Cloth"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MR_BONES] = "Resuscuta a cuori pieni se solo {{REG_Yellow}}1{{CR}} Buio non \232 sconfitto #!!! I Bui non disponibili contano come sconfitti #{{REG_Mint}}[[CHANCE]] probabilit\224 su 5{{CR}} di attivare {{Collectible545}} Book of the Dead completando una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.ONIX_AGATE] = "{{Damage}} Le carte di {{REG_Club}} {{REG_CChips}}Fiori{{CR}} danno {{REG_CMult}}+0.07{{CR}} Danno quando attivate #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno) #{{Bomb}} Le esplosioni di {{ColorClub}}Fiori{{CR}} sono pi\242 frequenti, pi\242 grandi infliggono pi\242 danno"
Descriptions.Jimbo.Jokers[mod.Jokers.ARROWHEAD] = "{{Tears}} Le carte di {{REG_Spade}} {{REG_CSpade}}Picche{{CR}} danno {{REG_CChips}}+0.5{{CR}} Lacrime quando attivate #{{Blank}} {{ColorGray}}(Attualmente {{REG_CChips}}+[[VALUE1]]{{ColorGray}} Lacrime) #{{Confusion}} Le carte di {{REG_CSpade}}Picche{{CR}} hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} di rallentare e confondere"
Descriptions.Jimbo.Jokers[mod.Jokers.BLOODSTONE] = "{{Damage}} Le carte di {{REG_Heart}} {{REG_CMult}}Cuori{{CR}} hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} di dare {{REG_CMult}}X1.05{{CR}} Molt. di Danno quando attivate #{{REG_Heart}} Le carte di {{REG_CMult}}Cuori{{CR}} hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 5{{CR}} di {{Charm}} ammaliare"
Descriptions.Jimbo.Jokers[mod.Jokers.ROUGH_GEM] = "{{Coin}} Le carte di {{REG_Diamond}} {{REG_Yellow}}Quadri{{CR}} hannoa {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} di creare una {{Coin}} {{REG_Yellow}}Moneta Temporanea{{CR}} quando attivate #{{Collectible506}} Le carte di  {{REG_Diamond}} {{REG_Yellow}}Quadri{{CR}} hanno anche l'effetto di {{REG_Yellow}}Backstabber"

Descriptions.Jimbo.Jokers[mod.Jokers.GROS_MICHAEL] = "{{Damage}} {{REG_CMult}}+0.75{{CR}} Danno #{{Warning}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 6{{CR}} di distruggersi quando un Buio viene sconfitto"
Descriptions.Jimbo.Jokers[mod.Jokers.CAVENDISH] = "{{Damage}} {{REG_CMult}}X1.5{{CR}} Molt. di Danno #{{Warning}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 1000{{CR}} di distruggersi quando un Buio viene sconfitto"
Descriptions.Jimbo.Jokers[mod.Jokers.FLASH_CARD] = "{{Damage}} {{REG_CMult}}+0.02{{CR}} Danno per {{RestockMachine}} Restock machine attivata #{{Collectible105}} {{Damage}} {{REG_CMult}}+0.02{{CR}} Danno per {{REG_Yellow}}Dado{{CR}} usato #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CLOUD_NINE] = "{{Coin}} {{REG_Yellow}}+1${{CR}} per {{REG_Yellow}}9{{CR}} nel tuo mazzo completo #{{Blank}} {{ColorGray}}(Attualmente  {{REG_Yellow}}[[VALUE1]]{{ColorGray}} Coins){{CR}} #{{Seraphim}} D\224 volo"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CARTOMANCER] = "{{Card}} Crea un {{ColorPink}}Tarocco{{CR}} casuale quando un Buio viene sconfitto #{{Card}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 20{{CR}} per ogni pickup di essere un {{ColorPink}}Tarocco"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SLY_JOKER] = "{{Tears}} {{REG_CChips}}+5{{CR}} Lacrime se una {{REG_Yellow}}Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.WILY_JOKER] = "{{Tears}} {{REG_CChips}}+10{{CR}} Lacrime se un {{REG_Yellow}}Tris{{CR}} \232 tenuto in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.CLEVER_JOKER] = "{{Tears}} {{REG_CChips}}+7{{CR}} Lacrime se una {{REG_Yellow}}Doppia Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.DEVIOUS_JOKER] = "{{Tears}} {{REG_CChips}}+15{{CR}} Lacrime se una {{REG_Yellow}}Scala{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.CRAFTY_JOKER] = "{{Tears}} {{REG_CChips}}+12{{CR}} Lacrime se un {{REG_Yellow}}Colore{{CR}} \232 tenuto in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.JOLLY_JOKER] = "{{Damage}} {{REG_CMult}}+1{{CR}} Danno se una {{REG_Yellow}}Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.ZANY_JOKER] = "{{Damage}} {{REG_CMult}}+2{{CR}} Danno se un {{REG_Yellow}}Tris{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.MAD_JOKER] = "{{Damage}} {{REG_CMult}}+1.75{{CR}} Danno se una {{REG_Yellow}}Doppia Coppia{{CR}} \232 tenuta in mano entrando in una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.CRAZY_JOKER] = "{{Damage}} {{REG_CMult}}+3{{CR}} Danno se una {{REG_Yellow}}Scala{{CR}} \232 tenuta in mano entrando in una stanza"

Descriptions.Jimbo.Jokers[mod.Jokers.MIME] = "{{REG_Retrigger}} {{REG_Yellow}}Riattiva{{CR}} le abilit\224 {{REG_Yellow}}tenute in mano{{CR}} #{{REG_Mint}}[[CHANCE]] probabilit\224 su 5{{CR}} di copiare l'effetto di un Oggetto Attivo usato"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MERRY_ANDY] = "{{Heart}} {{REG_Yellow}}+2{{CR}} Hp #{{REG_HSize}}  {{REG_CMult}}-2{{CR}} Carte in mano #{{Heart}} Cura un cuore aggiuntivo completando una stanza"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BANNER] = "{{Tears}} {{REG_CChips}}+1.5{{CR}} Lacrime per {{Heart}} {{REG_Yellow}}Cuore pieno #{{Blank}} {{ColorGray}}(Attualmente {{REG_CChips}}+[[VALUE1]]{{ColorGray}} Lacrime) #Uno stendardo appare entrando in una stanza #{{IND}}{{Tears}} Stare vicino allo stendardo d\224 {{REG_CChips}}+3{{CR}} Lacrime"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MARBLE_JOKER] = "{{REG_Stone}} Aggiunge una {{REG_Yellow}}Carta di Pietra{{CR}} al mazzo ogni {{REG_Yellow}}Buio{{CR}} sconfitto #{{REG_Mint}}[[CHANCE]] probabilit\224 su 100{{CR}} aggiuntiva di generare delle {{REG_Yellow}}Tinted Rock"
Descriptions.Jimbo.Jokers[mod.Jokers._8_BALL] = "{{Card}} Gli {{REG_Yellow}}8{{CR}} hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 8{{CR}} di creare un {{Card}} {{ColorPink}}Tarot{{CR}} tarocco casuale quando attivati #{{Shotspeed}} +0.16 Shot Speed"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RAISED_FIST] = "{{Damage}} {{REG_CMult}}+0.05{{CR}} Danno {{REG_Yellow}}X il Valore{{CR}} pi\242 basso delle carte {{REG_Yellow}}tenute in mano{{CR}} #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FIBONACCI] = "{{Damage}} Gli {{REG_Yellow}}Assi{{CR}}, {{REG_Yellow}}2{{CR}}, {{REG_Yellow}}3{{CR}}, {{REG_Yellow}}5{{CR}} e {{REG_Yellow}}8{{CR}} danno {{REG_CMult}}+0.08{{CR}} Danno quando attivati #{{Damage}} {{REG_CMult}}+0.05{{CR}} Danno per {{Collectible}} oggetto avuto se il numero totale \232 nella sequanza di {{REG_Yellow}}Fibonacci #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SCARY_FACE] = "{{Tears}} Le {{REG_Face}} {{REG_Yellow}}Figure{{CR}} danno {{REG_CChips}}+0.3{{CR}} Lacrime quando attivate #{{Tears}} Uccidere un {{REG_Yellow}}Champion{{CR}} d\224 {{REG_CChips}}+1{{CR}} Lacrime"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PAREIDOLIA] = "{{REG_Face}} Ogni carta conta come {{REG_Yellow}}Figure{{CR}} #{{REG_Mint}}[[CHANCE]] probabilit\224 su 5{{CR}} aggiuntiva per ongi nemico non boss di essere un {{REG_Yellow}}Champion"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BUSINESS_CARD] = "{{Coin}} Le {{REG_Yellow}}Figure{{CR}} hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} di creare {{REG_Yellow}}2 Monete Temporanee{{CR}} quando attivate #{{Collectible602}} Ottieni l'effetto di Member Card"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SPACE_JOKER] = "{{REG_Planet}} {{REG_Mint}}[[CHANCE]] probabilit\224 su 20{{CR}} di potenziare il livello del {{REG_Yellow}}Valore{{CR}} attivato # {{REG_Mint}}[[CHANCE]] probabilit\224 su 20{{CR}} per oggetto {{REG_Yellow}}Stellare{{CR}} avuto"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RUNNER] = "{{Tears}} Ottiene {{REG_CChips}}+1.5{{CR}} Lacrime entrando in una stanza ostile {{REG_Yellow}}inesplorata{{CR}} tenendo una {{REG_Yellow}}Scala{{CR}} #{{Tears}} Gives {{REG_CChips}}+Lacrime{{CR}} equal to double your {{Speed}} Speed stat#{{Blank}}(Attualmente {{REG_CChips}}+[[VALUE1]]{{ColorGray}} Fiches) #{{Speed}} +0.1 Speed"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SIXTH_SENSE] = "{{REG_Spectral}} Se la {{REG_Yellow}}prima{{CR}} carta attivata di un {{REG_Yellow}}Buio{{CR}} \232 un {{REG_Yellow}}6{{CR}} e colpisce un nemico, si distrugge e crea una {{ColorBlue}}Busta Spettrale{{CR}} #{{Collectible3}} 1 lacrima ogni 4 ottiene homing"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SEANCE] = "{{REG_Spectral}} Crea una {{REG_Yellow}}Busta Spettrale{{CR}} entrando in una stanza ostile {{REG_Yellow}}inesplorata{{CR}} avendo una {{REG_Yellow}}Scala Colore{{CR}} in mano #{{Collectible727}} {{REG_Mint}}[[CHANCE]] possibilit\224 su 6{{CR}} di creare una {{REG_Yellow}}Hungry Soul{{CR}} uccidendo un nemico"
Descriptions.Jimbo.Jokers[mod.Jokers.VAMPIRE] = "{{Damage}} Quando una carta {{REG_Yellow}}Potenziata{{CR}} \232 giocata, ottiene {{REG_CMult}}X0.02{{CR}} Molt. di Danno e rimuove il {{REG_Yellow}}Potenziamento {{CR}} #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}X[[VALUE1]]{{ColorGray}} Molt. di Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PHOTOGRAPH] = "{{Damage}} La prima {{REG_Face}} {{REG_Yellow}}Figura attivata{{CR}} della stanza d\224 {{REG_CMult}}X1.25{{CR}} Molt. di Danno quando attivata #{{Damage}} {{REG_CMult}}X1.5{{CR}} Molt. di Danno se il primo neico ucciso della stanza \232 un {{REG_Yellow}}Champion #{{Collectible327}} Pu\242 aprire la {{REG_Yellow}}Srange Door"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RESERVED_PARK] = "{{Coin}} Le {{REG_Face}} {{REG_Yellow}}Figure{{CR}} tanute in manoo hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 4{{CR}} di creare una moneta completando una stanza #{{Coin}} Uccidendo un nemico, gli altri {{REG_Yellow}}Champion{{CR}} creano una {{REG_Yellow}}Moneta Temporanea"
...
Descriptions.Jimbo.Jokers[mod.Jokers.TO_THE_MOON] = "{{Coin}} Gli {{colorYellow}}Interessi{{CR}} sono {{REG_Yellow}}Raddoppiati"
Descriptions.Jimbo.Jokers[mod.Jokers.JUGGLER] = "{{REG_HSize}} {{REG_Yellow}}+1{{CR}} Carte in mano #\1 {{REG_Yellow}}+1{{CR}} slot consumabili"
Descriptions.Jimbo.Jokers[mod.Jokers.DRUNKARD] = "{{Heart}} {{REG_Yellow}}+1{{CR}} Health up #{{Heart}} Cura di un cuore aggiuntivo completando una stanza"
Descriptions.Jimbo.Jokers[mod.Jokers.LUCKY_CAT] = "{{Damage}} Ottiene {{REG_CMult}}X0.02{{CR}} Molt. di Danno quando una {{REG_Yellow}}Carta Fortunata{{CR}} si attiva con {{REG_Mint}}Successo{{CR}} o quando una {{Slotmachine}} Slot d\224 un premio #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}X[[VALUE1]]{{ColorGray}} Molt. di Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SPARE_TROUSERS] = "{{Damage}} Ottiene {{REG_CMult}}+0.25{{CR}} Danno se una {{REG_Yellow}}Doppia Coppia{{CR}} \232 tenuta entrando in una stanza ostile #{{Damage}} {{REG_CMult}}+0.1{{CR}} Danno per {{REG_Yellow}}costume{{CR}} visibile #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SMILEY_FACE] = "{{Damage}} Le {{REG_Face}} {{REG_Yellow}}Figure{{CR}} danno {{REG_CMult}}+0.05{{CR}} Danno quando attivate #{{Damage}} Uccidere un {{REG_Yellow}}Champion{{CR}} d\224 {{REG_CMult}}+0.15{{CR}} Danno #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}+[[VALUE1]]{{ColorGray}} Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.GOLDEN_TICKET] = "{{REG_Gold}} Le {{REG_Yellow}}Carte Dorate{{CR}} danno {{REG_Yellow}}+1 {{Coin}} Moneta{{CR}} quando attivate #{{Collectible202}} Ogni pickup ha {{REG_Mint}}[[CHANCE]] probabilit\224 su 25{{CR}} di diventare la sua variante {{REG_Yellow}}dorata"
Descriptions.Jimbo.Jokers[mod.Jokers.ACROBAT] = "{{Damage}} Le {{REG_Yellow}}Ultime 5{{CR}} carte giocabili {{REG_CMult}}X1.1{{CR}} Molt. di Danno quando attivate #{{Damage}} {{REG_CMult}}X1.5{{CR}} Molt. di Danno durante le {{Boss}} bossfight #{{Blank}} {{ColorGray}}(Attualmente [[VALUE1]] {{ColorGray}})"
...
Descriptions.Jimbo.Jokers[mod.Jokers.HANG_CHAD] = "{{REG_Retrigger}} {{REG_Yellow}}Riattiva{{CR}} 3 volte la prima {{REG_Yellow}}carta{{CR}} giocata in una stanza #{{Card}} La {{REG_Yellow}}prima{{CR}} carta usata di un piano crea una copia di s\232 stessa qunado usata"
Descriptions.Jimbo.Jokers[mod.Jokers.GLASS_JOKER] = "{{Damage}} Ottiene {{REG_CMult}}X0.2{{CR}} Molt. di Danno per {{REG_Yellow}}Carta di Vetro{{CR}} distrutta  #{{IND}}!!! {{REG_Mint}}Raddioppia{{CR}} la possibilit\224 di rottura #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}X[[VALUE1]]{{REG_Yellow}} Molt. di Danno)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FLOWER_POT] = "{{Damage}} {{REG_CMult}}X2{{CR}} Molt. di Danno se ogni {{REG_Yellow}}Seme{{CR}} \232 tenuto in mano entrando in una stanza ostile #{{Charm}} Crea 3 fiori ammalianti nelle stanze ostili"
...
Descriptions.Jimbo.Jokers[mod.Jokers.OOPS_6] = "{{Luck}} Ogni {{REG_Mint}}Probabilit\224{{CR}} \232 raddoppiata #{{Collectible46}} Ottieni l'effetto di Lucky Foot"
Descriptions.Jimbo.Jokers[mod.Jokers.IDOL] = "{{Damage}} [[VALUE1]]{{CR}} d\224 {{REG_CMult}}X1.1{{CR}} Molt. di Danno quando attivato #{{ColorGray}} (Carta cambia ongi stanza) #{{Damage}} {{REG_CMult}}X2{{CR}} Molt. di Danno per {{REG_Yellow}} {{Collectible[[VALUE2]]}} [[VALUE3]]{{CR}} avuto"
...
Descriptions.Jimbo.Jokers[mod.Jokers.DUO] = "{{Damage}} {{REG_CMult}}X1.25{{CR}} Molt. di Danno se una {{REG_Yellow}}Coppia{{CR}} \232 tenuta entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.TRIO] = "{{Damage}} {{REG_CMult}}X1.5{{CR}} Molt. di Danno se un {{REG_Yellow}}Tris{{CR}} \232 tenuto entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.FAMILY] = "{{Damage}} {{REG_CMult}}X2{{CR}} Molt. di Danno se un {{REG_Yellow}}Poker{{CR}} \232 tenuto entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.ORDER] = "{{Damage}} {{REG_CMult}}X2.5{{CR}} Molt. di Danno se una {{REG_Yellow}}Scala{{CR}} \232 tenuta entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
Descriptions.Jimbo.Jokers[mod.Jokers.TRIBE] = "{{Damage}} {{REG_CMult}}X1.55{{CR}} Molt. di Danno se un {{REG_Yellow}}Colore{{CR}} \232 tenuto entrando in una stanza #{{Blank}} {{ColorGray}}(Attualmente: [[VALUE1]]{{ColorGray}})"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ASTRONOMER] = "{{Shop}} Le {{ColorCyan}}Carte Planet{{CR}}, {{ColorCyan}}Buste Celestiali{{CR}} e gli oggetti {{REG_Yellow}}Stellari{{CR}} sono gratuiti #{{Planetarium}} {{REG_Yellow}}+20%{{CR}} possibilit\224 del planetario {{ColorGray}}(Dimezzata per ogni planetario visitato) #{{Planetarium}} I Planetari possono apparire in ogni piano normale"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CANIO] = "{{Damage}} Ottiene {{REG_CMult}}X0.25{{CR}} Molt. di Danno quandu una {{REG_Face}} {{REG_Yellow}}Figura{{CR}} viene {{REG_Yellow}}Distrutta #{{Blank}} {{ColorGray}}(Attualmente {{REG_CMult}}X[[VALUE1]]{{CR}} Molt. di Danno) #{{DeathMark}} I nemici {{REG_Yellow}}Champion{{CR}} vengono uccisi immediatamente"
...
Descriptions.JokerSynergies[mod.Jokers._8_BALL][CollectibleType.COLLECTIBLE_MAGIC_8_BALL] = "{{REG_Mint}}Probabilit\224{{CR}} raddoppiata!"

Descriptions.JokerSynergies[mod.Jokers.MISPRINT] = {}
Descriptions.JokerSynergies[mod.Jokers.MISPRINT][CollectibleType.COLLECTIBLE_TMTRAINER] = "Il danno dato \232 compreso tra {{REG_CMult}}-0.5{{CR}} e {{REG_CMult}}+2.5"
...
Descriptions.JokerSynergies[mod.Jokers.GOLDEN_JOKER][CollectibleType.COLLECTIBLE_SMELTER] = "{{Coin}} D\224 anche 2 {{REG_Yellow}}Monete dorate{{CR}} quando vednuto in questo modo"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_C_SECTION] = "#{{REG_Jimbo}} Le carte sparano un feto quando atterrano #{{IND}}{{REG_Heart}} Le carte di {{REG_CMult}}Cuori{{CR}} sparano un feto in pi\242 #{{REG_Heart}} Le carte in mano diventano di {{REG_CMult}}Cuori{{CR}} quando preso"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_HALLOWED_GROUND] = "#{{REG_Jimbo}} le carte giocate vengono {{REG_Retrigger}} {{REG_Yellow}}Riattivate{{CR}} mentre si \232 all'interno dell'aura"
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_STAR_OF_BETHLEHEM] = "#{{REG_Jimbo}} le carte giocate vengono {{REG_Retrigger}} {{REG_Yellow}}Riattivate{{CR}} mentre si \232 all'interno dell'aura"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_CUPIDS_ARROW] = "#{{REG_Jimbo}} Le carte di {{REG_Spade}} {{REG_CSpade}}Picche{{CR}} hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} di {{Charm}} ammaliare i nemici"
...
Descriptions.JimboSynergies[CollectibleType.COLLECTIBLE_WHORE_OF_BABYLON] = "#{{REG_Jimbo}} Il danno dato dai {{REG_Mult}} {{REG_Yellow}}Potensiamenti Molt{{CR}} \232 raddoppiato"
...
Descriptions.Jimbo.Consumables[Card.CARD_EMPRESS] = "{{REG_Mult}} Cambia fino a {{REG_Yellow}}2{{CR}} carte nella tua mano in {{REG_Yellow}}Carte Mult"
Descriptions.Jimbo.Consumables[Card.CARD_EMPEROR] = "{{Card}} Crea {{REG_Yellow}}2{{CR}} {{ColorPink}}Tarocchi{{CR}} casuali #{{IND}}!!! Eccetto s\232 stesso"
...
Descriptions.Jimbo.Consumables[Card.CARD_WHEEL_OF_FORTUNE] = "{{REG_Mint}}[[CHANCE]] probabilit\224 su 4{{CR}} di dare un'{{REG_Yellow}}Edizione{{CR}} ad un Jolly avuto #{{IND}}!!! Non pu\242 rimpiazzare edizioni gi\224 esistenti"
...
Descriptions.Jimbo.Consumables[Card.CARD_TEMPERANCE] = "{{Coin}} D\224 il {{REG_Yellow}}valore di vendita{{CR}} totale dei Jolly avuti in {{Coin}} Monete"
...
Descriptions.Jimbo.Consumables[Card.CARD_JUDGEMENT] = "{{REG_Joker}} D\224 un {{REG_Yellow}}Jolly{{CR}} casuale #{{IND}}!!! Serve spazio nell'invetario"
...
Descriptions.Jimbo.Consumables[mod.Planets.MERCURY] = "I {{REG_Yellow}}2{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.URANUS] = "I {{REG_Yellow}}3{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.VENUS] = "I {{REG_Yellow}}4{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.SATURN] = "I {{REG_Yellow}}5{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.JUPITER] = "I {{REG_Yellow}}6{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.EARTH] = "I {{REG_Yellow}}7{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.MARS] = "Gli {{REG_Yellow}}8{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.NEPTUNE] = "I {{REG_Yellow}}9{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.PLANET_X] = "I {{REG_Yellow}}10{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.CERES] = "I {{REG_Yellow}}Jack{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
Descriptions.Jimbo.Consumables[mod.Planets.ERIS] = "Le {{REG_Yellow}}Regine{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivate"
Descriptions.Jimbo.Consumables[mod.Planets.SUN] = "I {{REG_Yellow}}Re{{CR}} attivati danno {{REG_CChips}}+0.02{{CR}} Lacrime and {{REG_CMult}}+0.02{{CR}} Danno quando attivati"
...
Descriptions.T_Jimbo.Vouchers[mod.Vouchers.Retcon] = "{{ColorPink}}Cambia{{CR}} il buio boss {{REG_Yellow}}infinite{{CR}} volte per Ante#({{REG_Yellow}}10${{CR}} per ogni cambio)"
    ...
    EID:addCollectible(mod.Vouchers.Hone, "{{REG_Jimbo}} Le {{ColorRainbow}}Edizioni{{CR}} speciali appaiono {{REG_Yellow}}2x{{CR}} pi\242 frequentemente", "Lucidatura", FileLanguage)
    EID:addCollectible(mod.Vouchers.GlowUp, "{{REG_Jimbo}} Le {{ColorRainbow}}Edizioni{{CR}} speciali appaiono {{REG_Yellow}}4x{{CR}} pi\242 frequentemente", "Perfezionamento", FileLanguage)

    EID:addCollectible(mod.Vouchers.RerollSurplus, "{{REG_Jimbo}} Attivare una {{RestockMachine}} Restock Machine rid\224 indietro {{REG_Yellow}}1{{CR}} {{Coin}} Moneta", "Cambi in Surplus", FileLanguage)
    EID:addCollectible(mod.Vouchers.RerollGlut, "{{REG_Jimbo}} Attivare una {{RestockMachine}} Restock Machine rid\224 indietro {{REG_Yellow}}2{{CR}} {{Coin}} Monete", "Eccesso di Cambi", FileLanguage)
    ...
    EID:addCollectible(mod.Vouchers.MagicTrick, "Le buste di espansione hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 4{{CR}} di permettere una scelta aggiuntiva dopo la precedente #{{IND}} Pu\242 attivarsi pi\242 volte", "Trucco di Magia", FileLanguage)
    EID:addCollectible(mod.Vouchers.Illusion, "Le buste di espansione hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 2{{CR}} di contenere {{REG_Yellow}}2{{CR}} opzioni in pi\242 #Le buste di espansione hanno {{REG_Mint}}[[CHANCE]] probabilit\224 su 5{{CR}} di permettere {{REG_Yellow}}1{{CR}} scelta aggiuntiva", "Illusione", FileLanguage)
    ...
    EID:addCollectible(mod.Vouchers.PlanetMerch, "{{REG_Planet}} Ogni pickup ha {{REG_Mint}}[[CHANCE]] probabilit\224 su 15{{CR}} di essere rimpiazzato con una {{ColorCyan}}Carta Pianeta{{CR}} casuale", "Mercante di Pieneti", FileLanguage)
    EID:addCollectible(mod.Vouchers.PlanetTycoon, "{{REG_Planet}} Ogni pickup ha {{REG_Mint}}[[CHANCE]] probabilit\224 su 10{{CR}} aggiuntiva di essere rimpiazzato con una {{ColorCyan}}Carta Pianeta{{CR}} casuale", "Magnate di Pianeti", FileLanguage)

    EID:addCollectible(mod.Vouchers.TarotMerch, "{{Card}} Ogni pickup ha {{REG_Mint}}[[CHANCE]] probabilit\224 su 15{{CR}} di essere rimpiazzato con un {{ColorPink}}Tarocco{{CR}} casuale", "Mercante di Tarocchi", FileLanguage)
    EID:addCollectible(mod.Vouchers.TarotTycoon, "{{Card}} Ogni pickup ha {{REG_Mint}}[[CHANCE]] probabilit\224 su 10{{CR}} aggiuntiva di essere rimpiazzato con un {{ColorPink}}Tarot Card{{CR}} casuale", "Magnate di Tarocchi", FileLanguage)
    ...
    Descriptions.PackSynergies[mod.Vouchers.MagicTrick] = "#{{Collectible"..mod.Vouchers.MagicTrick.."}} Dopo aver preso una scelta, {{REG_Mint}}[[CHANCE]] probabilit\225 su 4{{CR}} di permetterne una aggiuntiva"
    Descriptions.PackSynergies[mod.Vouchers.Illusion] = "#{{Collectible"..mod.Vouchers.Illusion.."}} {{REG_Mint}}[[CHANCE]] probabilit\225 su 2{{CR}} di avere {{REG_Yellow}}+1{{CR}} opzione disponibile #{{Collectible"..mod.Vouchers.Illusion.."}} {{REG_Mint}}[[CHANCE]] probabilit\225 su 5{{CR}} di permettere un scelta aggiuntiva"
...
EID:addCharacterInfo(mod.Characters.JimboType, "#Le carte sparate dalla tua {{REG_HSize}} mano possono assegnare punti un nmero limitato di volte per stanza o finchè il mazzo non viene rimischiato #Le statistiche ottenute così sono azzerate ogni stanza completata #Scarta la tua mano subendo danno #Gli Hp up normali sono trasformati in {{REG_Yellow}}buste di espansione #{{Shop}} Sconfiggi un buio entrando in un {{REG_Yellow}}negozio{{CR}} o battendo il {{REG_Yellow}}boss{{CR}} del piano, guadagnando così monete ed interessi #Saltare un buio andando al prossimo piano premia con {{REG_Yellow}}buste di espansione", "Jimbo", FileLanguage)

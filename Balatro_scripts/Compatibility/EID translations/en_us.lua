...
Descriptions.Jimbo.Jokers[mod.Jokers.POPCORN] = "{{Damage}} {{ColorMult}}+[[VALUE1]]{{CR}} Damage #!!! Loses {{ColorMult}}-0.3{{CR}} Damage every blind beaten #Randomly launch exploding popcorn"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MYSTIC_SUMMIT] = "{{Damage}} {{ColorMult}}+1.5{{CR}} Damage while having only {{ColorYellorange}}1{{CR}} full Heart #{{Collectible 553}} Grants a {{ColorYellorange}}repelling aura{{CR}} while active"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BOOTSTRAP] = "{{Damage}} {{ColorMult}}+0.1{{CR}} Damage per {{ColorYellorange}}5 {{Coin}} Coins{{CR}} held {{ColorGray}}#{{Blank}} (Currently {{ColorMult}}+[[VALUE1]]{{ColorGray}} Damage) #Gain {{ColorYellorange}}Collision Damage{{CR}} equal to the amount of coins held"

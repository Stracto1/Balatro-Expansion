...
Descriptions.Jimbo.JokerEdition[mod.Edition.FOIL] = "#{{Tears}} {{ColorChips}}Foil{{CR}}: {{ColorChips}}+2.5{{CR}} Tears while held"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ODDTODD] = "{{Tears}} Odd numbered cards give {{ColorChips}}+0.31{{CR}} Tears when scored#{{Tears}} {{ColorChips}}+0.07{{CR}} Tears per Collectible held if the total amount is odd#{{Blank}} {{ColorGray}}(Currently {{ColorChips}}+[[VALUE1]]{{ColorGray}} Tears)"
Descriptions.Jimbo.Jokers[mod.Jokers.EVENSTEVEN] = "{{Damage}} {{ColorMult}}+0.04{{CR}} Damage per Even numbered card triggered this room #{{Damage}} {{ColorMult}}+0.02{{CR}} Damage per Collectible held if the total amount is even#{{Blank}} {{ColorGray}}(Currently {{ColorMult}}+[[VALUE1]]{{ColorGray}} Damage)"
Descriptions.Jimbo.Jokers[mod.Jokers.HALLUCINATION] = "{{ColorMint}}[[CHANCE]]/2 Chance{{CR}} to spawn a random {{Card}}{{ColorPink}}Tarot{{CR}} card when opening a {{ColorYellorange}}Booster Pack{{CR}}#\1 {{ColorMint}}[[CHANCE]]/2 Chance{{CR}} to give a {{Collectible431}} Multidimensional Baby every room entered"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SACRIFICIAL_DAGGER] = "Destroys the Joker to its right and gains {{ColorMult}}+0.08 x the destroyed Joker's sell value{{CR}} Damage on Blind clear #{{Blank}} {{colorGray}}(Currently {{ColorMukt}}+[[VALUE1]]{{ColorGray}} Damage)"
Descriptions.Jimbo.Jokers[mod.Jokers.CLOUD_NINE] = "Gain {{ColorYellow}}1 {{Coin}} Coin{{CR}} per {{ColorYellorange}}9{{CR}} in your Full Deck on Blind clear#{{Blank}} {{Colorgray}}(Currently  {{colorYellow}}[[VALUE1]]{{ColorGray}} Coins){{CR}} #{{Seraphim}} Gain Flight"
Descriptions.Jimbo.Jokers[mod.Jokers.SWASHBUCKLER] = "{{Damage}} Gives {{Damage}}{{ColorMult}}+0.05 x the total sell value of all held Jokers{{CR}} Damage"
...
Descriptions.Jimbo.Jokers[mod.Jokers.DELAYED_GRATIFICATION] = "Gives {{ColorYellow}}1 {{Coin}} Coin{{CR}} per {{Heart}} full heart when clearing a room at {{ColorYellorange}}full health{{CR}} #{{Timer}} Both the {{Boss}} Bossrush and {{Hush}} Hush door open regardless of the ingame timer"
Descriptions.Jimbo.Jokers[mod.Jokers.EGG] = "The sell value of this Joker increases by {{ColorYellorange}}2{{CR}} every blind clear"
Descriptions.Jimbo.Jokers[mod.Jokers.DNA] = "If the {{ColorYellorange}}First{{CR}} card played in a {{ColorYellorange}}Blind{{CR}} hits an enemy, add a copy of that card to the deck #{{Collectible658}} Spawns a Mini-Isaac on room clear"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SLY_JOKER] = "{{Tears}} {{ColorChips}}+4{{CR}} Tears if a {{ColorYellorange}}Pair{{CR}} is held when entering a room"
Descriptions.Jimbo.Jokers[mod.Jokers.WILY_JOKER] = "{{Tears}} {{ColorChips}}+8{{CR}} Tears if a {{ColorYellorange}}Three of a kind{{CR}} is held when entering a room"
...
Descriptions.Jimbo.Jokers[mod.Jokers.DEVIOUS_JOKER] = "{{Tears}} {{ColorChips}}+12{{CR}} Tears if a {{ColorYellorange}}Straight{{CR}} is held when entering a room"
Descriptions.Jimbo.Jokers[mod.Jokers.CRAFTY_JOKER] = "{{Tears}} {{ColorChips}}+9{{CR}} Tears if a {{ColorYellorange}}Flush{{CR}} is held when entering a room"
...
Descriptions.Jimbo.Jokers[mod.Jokers.HALF_JOKER] = "{{Damage}} {{ColorMult}}+1.5{{CR}} Damage when {{CR}}5 or less{{CR}} card have been played in the current room #{{ColorMult}}+1{{CR}}Damage when having {{ColorYellorange}}3 or less{{CR}} cards in hand #{{Blank}} {{ColorGray}}(Currently {{ColorMult}}+[[VALUE1]]{{CR}} Damage)"
Descriptions.Jimbo.Jokers[mod.Jokers.CREDIT_CARD] = "Allows to go in {{ColorYellorange}}debt{{CR}} by spending more coins than you have#{{Shop}} Items on sale can only be bought with a maximum of {{ColorMult}}-20${{CR}} debt #!!! {{ColorYellow}}Interest{{CR}} and {{ColorYellow}}money-based{{CR}} effects cannot trigger while in debt"

Descriptions.Jimbo.Jokers[mod.Jokers.BANNER] = "{{Tears}} {{ColorChips}}+1.5{{CR}} Tears per {{Heart}} {{ColorYellorange}}full heart{{CR}}#(Currently {{ColorChips}}+[[VALUE1]]{{ColorGray}} Tears)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MARBLE_JOKER] = "Adds a {{ColorYellorange}}Stone card{{CR}} to the deck on blind clear"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CHAOS_CLOWN] = "{{Collectible376}} Every {{Shop}} Shop visited has an additional Restock Machine"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SCARY_FACE] = "{{Tears}} {{ColorYellorange}}Face{{CR}} cards give {{ColorChips}}+0.3{{CR}} Tears when scored #{{ColorChips}}+1{{CR}}Tears per {{ColorYellorange}}Champion enemy{{CR}} killed this room #{{Blank}} {{colorGray}}(Currently {{ColorChips}}+[[VALUE1]]{{ColorGray}} Chips)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RIDE_BUS] = "{{Damage}} {{ColorMult}}+0.01{{CR}}Damage per consecutive {{ColorYellorange}}non-Face{{CR}} card played"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BURGLAR] = "!!! Sets your Hp to {{ColorRed}}1{{CR}} Heart #\1 Cards can be scored until the deck gets {{ColorYellorange}}reshuffled{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RUNNER] = "{{Tears}} Gains {{ColorChips}}+2{{CR}} Tears when entering an {{ColorYellorange}}unexplored{{CR}} room while holding a {{ColorYellorange}}Straight{{CR}} #{{Tears}} Gives {{ColorChips}}+Tears{{CR}} equal to your {{Speed}} Speed stat#{{Blank}}(Currently {{ColorChips}}+[[VALUE1]]{{ColorGray}} Chips) #{{Speed}} +0.1 Speed"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CONSTELLATION] = "{{Damage}} This Jokers gains {{ColorMult}}+0.05X{{CR}} Damage Multiplier every time a {{ColorCyan}}Planet Card{{CR}} is used while holding it"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FACELESS] = "Gain {{ColorYellow}}3 Pennies{{CR}} when discarding at least {{ColorYellorange}}2{{CR}} Face cards at once #If only {{ColorYellorange}}Non-boss champion{{CR}} enemies are left in the room, they are {{ColorYellorange}}killed instantly{{CR}} #{{Coin}} Enemies killed this way spawn a {{ColorYellow}}temporary penny{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PHOTOGRAPH] = "{{Damage}} The first {{ColorYellorange}}Face{{CR}} card {{ColorYellorange}}Played{{CR}} every room gives {{ColorMult}}X1.2{{CR}} Damage Multiplier when {{ColorYellorange}}Scored{{CR}} #{{Damage}} Gives {{ColorMult}}X1.1{{CR}} Damage Multiplier when killing the first {{ColorYellorange}}Champion{{CR}} enemy in the room"
Descriptions.Jimbo.Jokers[mod.Jokers.GIFT_CARD] = "{{Coin}} Every Joker held gains {{ColorYellow}}+1{{CR}} selling value on blind clear"
Descriptions.Jimbo.Jokers[mod.Jokers.TURTLE_BEAN] = "\1 {{ColorYellorange}}+[[VALUE1]]{{CR}} Hand Size #!!! Bonus is decreased by {{ColorRed}}-1{{CR}} on blind clear"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RESERVED_PARK] = "{{ColorYellorange}}Face{{CR}} cards held in hand have a {{ColorMint}}[[CHANCE]]/4 Chance{{CR}} to spawn a penny on blind clear #When killing an enemy, other {{ColorYellorange}}Champion{{CR}} enemies have a {{ColorMint}}1/2 chance{{CR}} to spawn a {{ColorYellow}}Temporary penny{{CR}} close to them"

Descriptions.Jimbo.Jokers[mod.Jokers.MAIL_REBATE] = "{{Coin}} Gain {{ColorYellow}}2 pennies{{CR}} per {{ColorYellorange}}[[VALUE1]]{{CR}} discarded #{{ColorGray}} (Rank changes every room)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SELTZER] = "\1 {{ColorYellorange}}Retriggers{{CR}} all played cards #!!! {{ColorGray}}({{ColorYellorange}}[[VALUE1]]{{ColorGray}} Rooms remaining)"
Descriptions.Jimbo.Jokers[mod.Jokers.SMILEY_FACE] = "{{Damage}} {{ColorYellorange}}Face{{CR}} cards give {{ColorMult}}+0.05{{CR}} Damage when scored #Gives {{ColorMult}}+0.15{{CR}} Damage per {{ColorYellorange}}Champion{{CR}} enemy killed this room #{{Blank}} {{ColorGray}}(Currently {{ColorMult}}+[[VALUE1]]{{ColorGray}} Damage)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ACROBAT] = "{{Damage}} Gives {{ColorMult}}X2{{CR}} Damage Multipier when {{ColorYellorange}}5 or less{{CR}} scoring cards are left #!!! does not activate if no scoring cards are left #{{Damage}} Gives {{ColorMult}}X1.5{{CR}} Damage multiplier during any {{Boss}} bossfight #{{Blank}} {{ColorGray}}(Currently [[VALUE1]] {{ColorGray}})"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CERTIFICATE] = "\1 Adds a card with {{ColorYellorange}}Random Seal{{CR}} to the deck on blind clear [[VALUE1]][[VALUE2]]"
...
Descriptions.Jimbo.Jokers[mod.Jokers.GLASS_JOKER] = "{{Damage}} Gains {{ColorMult}}X0.2{{CR}} Damage Multiplier per destroyed {{ColorYellorange}}Glass Card{{CR}} #{{Blank}} {{ColorGray}}(Currently {{ColorMult}}X[[VALUE1]]{{ColorYellorange}} Damage Mult.)"
...
Descriptions.Jimbo.Jokers[mod.Jokers.TRIO] = "{{Damage}} {{ColorMult}}X1.5{{CR}} Damage Mutiplier if a {{ColorYellorange}}Three of a Kind{{CR}} is held when entering an hostile room #{{Blank}} {{ColorGray}}(Currently [[VALUE1]])"
Descriptions.Jimbo.Jokers[mod.Jokers.FAMILY] = "{{Damage}} {{ColorMult}}X2{{CR}} Damage Mutiplier if a {{ColorYellorange}}Four of a Kind{{CR}} is held when entering an hostile room #{{Blank}} {{ColorGray}}(Currently [[VALUE1]])"
Descriptions.Jimbo.Jokers[mod.Jokers.ORDER] = "{{Damage}} {{ColorMult}}X2.5{{CR}} Damage Mutiplier if a {{ColorYellorange}}Straight{{CR}} is held when entering an hostile room #{{Blank}} {{ColorGray}}(Currently [[VALUE1]])"
Descriptions.Jimbo.Jokers[mod.Jokers.TRIBE] = "{{Damage}} {{ColorMult}}X1.55{{CR}} Damage Mutiplier if a {{ColorYellorange}}Flush{{CR}} is held when entering an hostile room #{{Blank}} {{ColorGray}}(Currently [[VALUE1]])"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CANIO] = "Gains {{ColorMult}}X0.25{{CR}} Damage Multiplier when a {{ColorYellorange}}Face{{CR}} card is {{ColorYellorange}}Destroyed{{CR}}#{{Blank}} {{ColorGray}}(Currently {{ColorMult}}+[[VALUE1]]{{CR}} Damage Mult.) #{{DeathMark}} All {{ColorYellorange}}Champion{{CR}} enemies are immediantly killed"
...
EID:addCollectible(mod.Collectibles.BALOON_PUPPY, "Spawns a floating familiar that reflects shots back at enemies #Explodes dealing 3 x Isaac's Damage after taking enough damage #If Isaac takes damage, it starts chasing down enemies dealing 5 damage per second", "Baloon Puppy",FileLanguage)		
...
EID:addCollectible(mod.Collectibles.EMPTY_BANANA, "Leaves a banana peel on the ground #Enemies that slip on the peels take damage basing on how fast they were moving #!!! Entring a new floor recharges it to {{Collectible"..tostring(mod.Collectibles.BANANA).."}} Banana", "Empty Banana",FileLanguage)		
...
EID:addCollectible(mod.Collectibles.HORSEY, "Spawns a familiar Jumps in an L pattern, creating damaging shockwaves upon landing #!!! The shockwaves cannot hurt Isaac", "Horsey",FileLanguage)		
EID:addCollectible(mod.Collectibles.LAUGH_SIGN, "An audience reacts live to Isaac's actions #{{BossRoom}} Clearing a boss room rewards the player with random pickups #Taking launches tomatoes that leave a damaging creep and apply {{Bait}} Bait upon landing", "Laugh Sign",FileLanguage)		
EID:addCollectible(mod.Collectibles.LOLLYPOP, "{{Timer}} A lollypop spawns on the ground every 25 seconds spent in an uncleared room #{{Collectible93}} Picking up these lollypops grants the Gamekid! effect for 5.5 seconds #!!! A maximum of 3 lollypops can be on the ground at once", "Lollypop",FileLanguage)		
...
for i = 1, Balatro_Expansion.TastyCandyNum do --puts every candy stage
    ...
    EID:addTrinket(Balatro_Expansion.Trinkets.TASTY_CANDY[i], "{{Beggar}} Guarantees a payout when interacting with any beggar #!!! Uses left: {{ColorYellorange}}"..tostring(i), "Tasty Candy", FileLanguage)		
end

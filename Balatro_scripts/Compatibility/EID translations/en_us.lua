...
Descriptions.Jokers.Jimbo[mod.Jokers.DRIVER_LICENSE] = "{{PlayerJimbo}} {{ColorMult}}X1.5{{CR}} Damage Multiplier if Jimbo has at least {{ColorYellorange}}18 Enhanced cards{{CR}} in his deck or if he's an {{Adult}} adult"

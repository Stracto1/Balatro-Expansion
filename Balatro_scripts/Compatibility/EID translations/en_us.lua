...
Descriptions.Jimbo.Jokers[mod.Jokers.PHOTOGRAPH] = "{{Damage}} The first {{ColorYellorange}}Face{{CR}} card {{ColorYellorange}}Played{{CR}} every room gives {{ColorMult}}X1.2{{CR}} Damage Multiplier when {{ColorYellorange}}Scored{{CR}} #{{Damage}} Killing the first {{ColorYellorange}}Champion{{CR}} gives {{ColorMult}}X1.1{{CR}} Damage Multiplier #Can open {{ColorYellorange}}A Strange Door{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RESERVED_PARK] = "{{Coin}} {{ColorYellorange}}Face{{CR}} cards held in hand have a {{ColorMint}}[[CHANCE]]/4 Chance{{CR}} to spawn a penny on blind clear #When killing an enemy, other {{ColorYellorange}}Champions{{CR}} create a {{ColorYellow}}Vanishong penny{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MATADOR] = "{{Coin}} Gain {{ColorYellow}}3 pennies{{CR}} when taking damage from a {{ColorYellorange}}Boss{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SATELLITE] = "{{Coin}} Gain {{ColorYellow}}1 Coin{{CR}} per unique {{ColorCyan}}Planet{{CR}} card used this run on blind clear #(Currently {{ColorYellow}}[[VALUE1]]{{ColorGray}} Coins) #A light beam is shot per unique {{ColorCyan}}Planet{{CR}} card used when entering an hostile room"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.RAMEN] = " {{ColorMult}}X[[VALUE1]]{{B_Black}} Mult#loses {{ColorMult}}-0.01X{{B_Black}} per card discarded #{{Collectible682}} Gain a weaker copy of Worm Friend"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.MERRY_ANDY] = "{{ColorYellorange}}+3{{B_Black}} #{{ColorMult}}-1{{B_Black}} Hand size ##{{Heart}} Heal one extra heart on room clear"
...
Descriptions.Jimbo.Consumables[Card.CARD_HERMIT] = "Doubles you current money #!!! Can give up to {{ColorYellow}}20${{CR}}"
...
Descriptions.Jimbo.Consumables[Card.CARD_TEMPERANCE] = "Gives the total {{ColorYellow}}Sell value{{CR}} of you Jokers in {{Coin}}Pennies"

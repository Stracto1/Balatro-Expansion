...
Descriptions.Jimbo.Jokers[mod.Jokers.BULL] = "{{PlayerJimbo}} {{Tears}} {{ColorChips}}+0.15 {{CR}}Tears per {{Coin}} coin held"
...
Descriptions.Jimbo.Jokers[mod.Jokers.JOKER_STENCIL] = "{{PlayerJimbo}} {{ColorMult}}+0.75X{{CR}} Damage Multiplier per Joker slot being {{ColorYellorange}}empty{{CR}} or containing another {{ColorYellorange}}Joker Stencil{{CR}}#Not having any {{Collectible}}Active item gives and additional {{ColorMult}}+0.25X{{CR}} Damage Multiplier"
Descriptions.Jimbo.Jokers[mod.Jokers.STONE_JOKER] = "{{PlayerJimbo}} {{Tears}} {{ColorChips}}+1.25 {{CR}}Tears per per stone card in the player's full deck #Gives {{ColorChips}}+0.05 {{CR}}Tears per rock in the current room"
Descriptions.Jimbo.Jokers[mod.Jokers.ICECREAM] = "{{PlayerJimbo}} {{Tears}} {{ColorChips}}+4 {{CR}}Tears#Loses {{ColorChips}}-0.16{{CR}} Tears every room completed while held #Create a trail of slowing creep #Killing an enemy on top of the creep turns it in a Frozen Statue"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ODDTODD] = "{{PlayerJimbo}} {{Tears}} {{ColorChips}}+0.31 {{CR}} Tears per Odd numbered card triggered this room #{{PlayerJimbo}} {{Tears}} {{ColorChips}}+0.07{{CR}} Tears per Collectible held if the total amount is odd"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FORTUNETELLER] = "{{PlayerJimbo}} {{Damage}}{{ColorMult}}+0.04 {{CR}} Damage per {{Card}}{{ColorPink}} Tarot Card {{CR}}used throughout the run"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ONIX_AGATE] = "{{PlayerJimbo}} {{Damage}} {{ColorMult}}+0.07 {{CR}} Damage per Club card triggered in the room # {{Damage}} {{ColorChips}}+0.07{{CR}} Damage per {{Bomb}} Bomb held"
Descriptions.Jimbo.Jokers[mod.Jokers.ARROWHEAD] = "{{PlayerJimbo}} {{Tears}} {{ColorChips}}+0.5 {{CR}} Tears per {{ColorSpade}}Spade{{CR}} card triggered in the room # {{Tears}} {{ColorChips}}+0.5{{CR}} Tears per {{Key}} Key held"
Descriptions.Jimbo.Jokers[mod.Jokers.BLOODSTONE] = "{{PlayerJimbo}} {{ColorMint}} 1/2 chance {{CR}}per Heart card triggered to give {{Damage}} {{ColorMult}}X1.05 {{CR}} Damage Multiplier"
Descriptions.Jimbo.Jokers[mod.Jokers.ROUGH_GEM] = "{{PlayerJimbo}} {{ColorMint}} 1/2 chance {{CR}}per Diamond card triggered to spawn a {{Coin}}Coin that disappears shortly after #Every {{ColorYellorange}}Dimaond{{CR}} card shot also has the {{Collectible506}} Backstabber effect"
...
Descriptions.Jimbo.Jokers[mod.Jokers.FLASH_CARD] = "{{PlayerJimbo}} {{Damage}} {{ColorMult}}+0.02 {{CR}} Damage per {{RestockMachine}} Restock machine activated while holding this #{{Collectible105}} {{Damage}} {{ColorMult}}+0.02 {{CR}} Damage per {{ColorYellorange}}Dice Item{{CR}} ussed while holding this"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CLOUD_NINE] = "{{PlayerJimbo}} Gain 1 {{Coin}} Coin per {{ColorYellorange}}9{{CR}} in your Full Deck on every Blind clear #{{Seraphim}} Gives Flight"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SUPERNOVA] = "{{PlayerJimbo}} When a card is played, gives {{Damage}}{{ColorMult}} +0.01 {{CR}} Damage per time a card with the same Rank got played in the current room"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SMEARED_JOKER] = "{{PlayerJimbo}} {{ColorMult}}Hearts{{CR}} and {{ColorYellorange}}Diamonds{{CR}} count as the same suit #{{ColorSpade}}Spades{{CR}} and {{ColorBlue}}Clubs{{CR}} count as the same suit"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MIME] = "{{PlayerJimbo}} {{ColorYellorange}}Retriggers{{CR}} all {{ColorYellorange}}held in hand{{CR}} effects #{{ColorMint}}20% Chance{{CR}} to copy the effect of an Active Item or consumable used"
...
Descriptions.Jimbo.Jokers[mod.Jokers.WRATHFUL_JOKER] = "{{PlayerJimbo}} {{ColorMult}}+0.03 {{CR}}Damage per triggered {{ColorSpade}}Spade{{CR}} card {{ColorYellorange}}triggered{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MERRY_ANDY] = "{{PlayerJimbo}} {{ColorRed}}+2 Hp{{CR}} #{{ColorCyan}}-2 Hand size{{CR}} while held"
Descriptions.Jimbo.Jokers[mod.Jokers.HALF_JOKER] = "{{PlayerJimbo}} {{ColorMult}}+1.5 {{CR}}Damage when {{CR}}5 or less{{CR}} card have been played in the current room #{{PlayerJimbo}} {{ColorMult}}+1 {{CR}}Damage when having {{ColorYellorange}}3 or less{{CR}} cards in hand"
Descriptions.Jimbo.Jokers[mod.Jokers.CREDIT_CARD] = "{{PlayerJimbo}} Allows to go in {{ColorYellorange}}debt{{CR}} by spending more coins than you have#{{Shop}} Items on sale can only be bought with a maximum of {{ColorMult}}-20${{CR}} debt #!!! Interest and money-based effects cannot trigger while in debt"

Descriptions.Jimbo.Jokers[mod.Jokers.BANNER] = "{{PlayerJimbo}} {{ColorChips}}+1.5{{CR}} Tears per full {{Heart}}Red heart"
...
Descriptions.Jimbo.Jokers[mod.Jokers.RAISED_FIST] = "{{PlayerJimbo}} The held card with the {{ColorYellorange}}lowest Rank{{CR}} gives {{ColorMult}}0.05{{CR}} {{ColorYellorange}} X its Rank{{CR}} Damage"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PAREIDOLIA] = "{{PlayerJimbo}} Every card counts as a {{ColorYellorange}}Face card{{CR}} #{{ColorMint}}1/5 Chance{{CR}} for any non-boss enemy to become a {{ColorYellorange}}Champion{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.SPACE_JOKER] = "{{PlayerJimbo}} {{ColorMint}}1/20 Chance{{CR}} to upgrade the played card Rank's level #Gains an additional {{ColorMint}}1/20 Chance{{CR}} per {{ColorYellorange}}Star-related{{CR}} Item held"
Descriptions.Jimbo.Jokers[mod.Jokers.BURGLAR] = "{{PlayerJimbo}} Sets your Hp to {{ColorRed}}1{{CR}} Heart#Cards can be triggered until the deck gets {{ColorYellorange}}reshuffled{{CR}} every room"
Descriptions.Jimbo.Jokers[mod.Jokers.BLACKBOARD] = "{{PlayerJimbo}} {{ColorMult}}X2 {{CR}}Damage Multiplier if all cards held in hand are {{ColorSpade}}Spades{{CR}} or {{ColorChips}}Clubs{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.TO_DO_LIST] = "{{PlayerJimbo}} A random {{ColorYellorange}}Card Rank{{CR}} is chosen upon entering an hostile room #{{ColorYellorange}}Playing{{CR}} a card with that Rank spawns a vanishing penny"

Descriptions.Jimbo.Jokers[mod.Jokers.CARD_SHARP] = "{{PlayerJimbo}} Gives {{ColorMult}}X1.1{{CR}} Damage Multiplier when {{ColorYellorange}}Scoring{{CR}} 2 cards with the same rank consecutevely #{{Collectible665}} Allows Isaac to see the content of chests and sacks"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PHOTOGRAPH] = "{{PlayerJimbo}} The first {{ColorYellorange}}Face{{CR}} card {{ColorYellorange}}Played{{CR}} every room gives {{ColorMult}}X1.2{{CR}} Damage Multiplier when {{ColorYellorange}}Scored{{CR}} #Gives {{ColorMult}}X1.1{{CR}} Damage Multiplier when killing the first {{ColorYellorange}}Champion{{CR}} enemy in the room "
...
Descriptions.Jimbo.Jokers[mod.Jokers.MAIL_REBATE] = "{{PlayerJimbo}} A random {{ColorYellorange}}Card rank{{CR}} is chosen upon entering an hostile room #{{ColorYellorange}}Discarding{{CR}} a card with that rank spawns 2 {{Coin}} pennies"
...
Descriptions.Jimbo.Jokers[mod.Jokers.DRUNKARD] = "{{PlayerJimbo}} {{Heart}}{{ColorMult}} +1 Health up{{CR}} #Healing when at full heath makes Isaac vision more distorted #Taking damage reverts the distorsion"
...
Descriptions.Jimbo.Jokers[mod.Jokers.BASEBALL] = "{{PlayerJimbo}} Gives {{ColorMult}}X1.25{{CR}} Damage Multiplier per {{ColorMint}}Uncommon{{CR}} Joker held #Gives {{ColorMult}}X1.1{{CR}} Damage Multiplier per {{Quality2}} Item held"
...
Descriptions.Jimbo.Jokers[mod.Jokers.ACROBAT] = "{{PlayerJimbo}} Gives {{ColorMult}}X2{{CR}} Damage Multipier when {{ColorYellorange}}5 or less{{CR}} scoring cards are left"
...
Descriptions.Jimbo.Jokers[mod.Jokers.TROUBADOR] = "{{PlayerJimbo}} {{ColorYellorange}}+2{{CR}} Hand Size #{{ColorBlue}}-5 playable cards{{CR}} every room"
Descriptions.Jimbo.Jokers[mod.Jokers.THROWBACK] = "{{PlayerJimbo}} This gains {{ColorMult}}+0.05X{{CR}} Damage Multiplier per {{ColorYellorange}}Special room{{CR}} skipped in this run"
...
Descriptions.Jimbo.Jokers[mod.Jokers.GLASS_JOKER] = "{{PlayerJimbo}} This gains {{ColorMult}}+0.2X{{CR}} Damage Multiplier every time a {{ColorGlass}}Glass Card{{CR}} is destroyed"
...
Descriptions.Jimbo.Jokers[mod.Jokers.WEE_JOKER] = "{{PlayerJimbo}} This gains {{ColorChips}}+0.04{{CR}} Tears when a {{ColorYellorange}}2{{CR}} is {{ColorYellorange}}triggered{{CR}}#The samller you are, the higher the stats gained"
Descriptions.Jimbo.Jokers[mod.Jokers.OOPS_6] = "{{PlayerJimbo}} Every {{ColorMint}}Listed Chance{{CR}} is Doubled"
Descriptions.Jimbo.Jokers[mod.Jokers.IDOL] = "{{PlayerJimbo}} A random {{ColorYellorange}}Card{{CR}} from your deck is chosen upon entering an hostile room #Playing a card with the same {{ColorYellorange}}Value and Suit{{CR}} gives {{ColorMult}}X1.1{{CR}} Damage Multiplier"
...
Descriptions.Jimbo.Jokers[mod.Jokers.MATADOR] = "{{PlayerJimbo}} Gain {{ColorYellow}}+6${{CR}} when taking damage from a {{ColorYellorange}}Boss{{CR}}"
...
Descriptions.Jimbo.Jokers[mod.Jokers.STUNTMAN] = "{{PlayerJimbo}} {{ColorMult}}+12.5{{CR}} Tears #{{ColorMult}}-3{{CR}} Hand Size"
...
Descriptions.Jimbo.Jokers[mod.Jokers.DRIVER_LICENSE] = "{{PlayerJimbo}} {{ColorMult}}X1.5{{CR}} Damage Multiplier if there are at least {{ColorYellorange}}18 Enhanced cards{{CR}} in your full deck #Having either the {{Adult}} Adult, {{Mom}} Mom or {{Bob}} Bob transformation also activates the effect"
...
Descriptions.Jimbo.Jokers[mod.Jokers.CANIO] = "{{PlayerJimbo}} This gains {{ColorMult}}+0.25X{{CR}} Damage Multiplier when a {{ColorYellorange}}Face card{{CR}} is {{ColorYellorange}}Destroyed{{CR}} #All {{COlorYellorange}}Champion{{CR}} enemies are immediantly killed"
Descriptions.Jimbo.Jokers[mod.Jokers.TRIBOULET] = "{{PlayerJimbo}} {{ColorMult}}X1.2{{CR}} Damage Multiplier per {{ColorYellorange}}King or Queen{{CR}} scored this room"
Descriptions.Jimbo.Jokers[mod.Jokers.YORICK] = "{{PlayerJimbo}} This gains {{ColorMult}}+0.25X{{CR}} Damage Multiplier every {{ColorYellorange}}23{{CR}} cards discarded"
...
Descriptions.Jimbo.Jokers[mod.Jokers.PERKEO] = "{{PlayerJimbo}} Spawns a duplicate of every {{ColorYellorange}}Consumable{{CR}} held upon entering a {{Shop}} shop or a new floor"
end
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.BULL] = " {{ColorChips}}+2{{B_Black}} Chips per {{ColorYellow}}1${{B_Black}} you have#{{ColorGray}} (Currently {{ColorChips}}+[[VALUE]]{{ColorGray}} Chips)"
Descriptions.T_Jimbo.Jokers[mod.Jokers.INVISIBLE_JOKER] = "After {{ColorYellorange}}2{{B_Black}} rounds, sell this joker to {{ColorYellorange}}Duplicate{{B_Black}} a random Joker#{{ColorGray}} (Currently [[VALUE1]])[[VALUE2]]"
Descriptions.T_Jimbo.Jokers[mod.Jokers.ABSTRACT_JOKER] = "{{ColorMult}}+3{{B_Black}} Mult per Joker card#{{ColorGray}} (Currently +[[VALUE1]] {{ColorGray}}Mult)"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.GOLDEN_JOKER] = "Earn {{VolorYellow}}4${{B_Black}} at the end of round"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.LOYALTY_CARD] = " {{ColorMult}}X4{{B_Black}} Mult once every {{ColorYellorange}}6{{B_Black}}hands played #{{ColorGray}}([[VALUE1]] Remaining)"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.TO_DO_LIST] = "Gain {{ColorYellow}}4${{B_Black}} when played hand is a {{ColorYellorange}}[[VALUE1]]{{B_Black}}#(Hand hanges every round)"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.SELTZER] = "{{ColorYellorange}}Retriggers{{B_Black}} hands played# {{ColorGray}}({{ColorYellorange}}[[VALUE1]]{{ColorGray}} hands remaining)"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.FLOWER_POT] = "{{ColorChips}}X3{{B_Black}} Mult if {{COlorYellorange}}scoring{{B_Black}} cards contain all{{COlorYellorange}}Suits"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.SATELLITE] = "Earn {{ColorYellow}}1${{B_Black}} per unique {{ColorCyan}}Plane{{B_Black}} card used this run#{{ColorGray}}(Currently {{ColorYellow}}[[VALUE1]]&{{ColorGray}})"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.BOOTSTRAP] = "{{ColorMult}}+2{{B_Black}} Mult per {{ColorYellow}}5${{B_Black}} coins you have#{{ColorGray}}(Currently {{ColorMult}}+[[VALUE1]]{{ColorGray}})"
...
Descriptions.T_Jimbo.Jokers[mod.Jokers.YORICK] = "This gains {{ColorMult}}X1{{B_Black}} Mult once every {{ColorYellorange}}23{{B_Black}} cards discarded#{{ColorGray}}(Currently {{ColroMult}}X[[VALUE1]]{{ColorGray}} Mult)"
